...
| Flight / AI | Tameable flier, do_movement, skin randomization, flowers? (orig eats nothing) | Activity flight port w/ ownerFlying 1.75/3.5 (:291-378); skin re-roll 1/2000 (:174-176); **added** flower-eating heal (:266-289) | **PORTED**+ (flower eating is new) | **[Corrected 2026-09-04, ENT-S-119: orig Stinky.java:582-607 eats COAL ORE (scan_it :435-496 on field_150365_q), so "orig eats nothing" and "flower eating is new" were both wrong; the port's flower-eat was the divergence, replaced by the transcription.]**
