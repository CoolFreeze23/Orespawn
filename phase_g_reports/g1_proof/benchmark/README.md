...
- Captured: 2026-09-15T05:04:09.463734500Z
...
- Repository base revision: `8f835fe14839363c8d432eab367bfef1c2fe5870` (working content bound by source/input hashes).
...
- Classic median/p95: 0.049760000 / 0.063205000 ms.
- Candidate median/p95: 0.140350000 / 0.185785000 ms.
- Candidate 1% low: 4332.662 FPS (component-only inverse p99).
- WARNING — component median ratio delta: 182.05385852090026%; absolute p95 delta: 0.12257999999999999 ms.
...
- Scope: renderer vertex submission only; no window, GPU, client tick, or server.
- Classic median/p95: 0.111250000 / 0.142615000 ms.
- Candidate median/p95: 0.231585000 / 0.291475000 ms.
- Candidate 1% low: 2768.741 FPS (component-only inverse p99).
- WARNING — component median ratio delta: 108.16629213483147%; absolute p95 delta: 0.14885999999999999 ms.
...
- Scope: renderer vertex submission only; no window, GPU, client tick, or server.
- Classic median/p95: 0.080835000 / 0.097355000 ms.
- Candidate median/p95: 0.172545000 / 0.205120000 ms.
- Candidate 1% low: 3702.881 FPS (component-only inverse p99).
- WARNING — component median ratio delta: 113.45333085915752%; absolute p95 delta: 0.107765 ms.
...
- Classic median/p95: 0.000922500 / 0.001114500 ms.
- Candidate median/p95: 0.001894000 / 0.002312500 ms.
- Candidate 1% low: 396825.397 FPS (component-only inverse p99).
- WARNING — component median ratio delta: 105.31165311653115%; absolute p95 delta: 0.0011979999999999998 ms.
- Allocation classic/candidate: 280.000 / 280.000 bytes per frame.
- Model-bone instances: 700; MHLib parts: 0.

## Q6 status and exact mixed-100 warning numbers

- WARNING — mixed-100 component median ratio delta: 113.45333085915752%.
- WARNING — mixed-100 absolute component p95 delta: 0.107765 ms.
