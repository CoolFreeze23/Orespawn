...
- Captured: 2026-09-02T06:17:24.876608200Z
...
- Repository base revision: `fcf0f48b51abd20c570e7707327389567ab34514` (working content bound by source/input hashes).
...
- Classic median/p95: 0.047085000 / 0.072375000 ms.
- Candidate median/p95: 0.139250000 / 0.212250000 ms.
- Candidate 1% low: 3619.647 FPS (component-only inverse p99).
- WARNING — component median ratio delta: 195.7417436550918%; absolute p95 delta: 0.139875 ms.
...
- Scope: renderer vertex submission only; no window, GPU, client tick, or server.
- Classic median/p95: 0.103625000 / 0.134110000 ms.
- Candidate median/p95: 0.210570000 / 0.268985000 ms.
- Candidate 1% low: 3143.171 FPS (component-only inverse p99).
- WARNING — component median ratio delta: 103.20386007237636%; absolute p95 delta: 0.13487500000000002 ms.
...
- Scope: renderer vertex submission only; no window, GPU, client tick, or server.
- Classic median/p95: 0.077375000 / 0.103565000 ms.
- Candidate median/p95: 0.160390000 / 0.215510000 ms.
- Candidate 1% low: 3641.661 FPS (component-only inverse p99).
- WARNING — component median ratio delta: 107.28917609046849%; absolute p95 delta: 0.11194500000000002 ms.
...
- Classic median/p95: 0.000923500 / 0.001188000 ms.
- Candidate median/p95: 0.001901500 / 0.002452000 ms.
- Candidate 1% low: 365230.095 FPS (component-only inverse p99).
- WARNING — component median ratio delta: 105.90146182999459%; absolute p95 delta: 0.0012640000000000004 ms.
- Allocation classic/candidate: 280.000 / 280.000 bytes per frame.
- Model-bone instances: 700; MHLib parts: 0.

## Q6 status and exact mixed-100 warning numbers

- WARNING — mixed-100 component median ratio delta: 107.28917609046849%.
- WARNING — mixed-100 absolute component p95 delta: 0.11194500000000002 ms.
