...
- Captured: 2026-09-19T10:47:24.770686800Z
...
- Repository base revision: `2c4bcd5a3d8c8eb1db01bd47670fc87d130d60cd` (working content bound by source/input hashes).
...
- Classic median/p95: 0.042990000 / 0.053300000 ms.
- Candidate median/p95: 0.125595000 / 0.152145000 ms.
- Candidate 1% low: 4879.239 FPS (component-only inverse p99).
- WARNING — component median ratio delta: 192.14933705512914%; absolute p95 delta: 0.098845000000000002 ms.
...
- Scope: renderer vertex submission only; no window, GPU, client tick, or server.
- Classic median/p95: 0.105660000 / 0.118055000 ms.
- Candidate median/p95: 0.194285000 / 0.221525000 ms.
- Candidate 1% low: 3367.173 FPS (component-only inverse p99).
- WARNING — component median ratio delta: 83.877531705470361%; absolute p95 delta: 0.10347000000000001 ms.
...
- Scope: renderer vertex submission only; no window, GPU, client tick, or server.
- Classic median/p95: 0.076800000 / 0.086260000 ms.
- Candidate median/p95: 0.147385000 / 0.168405000 ms.
- Candidate 1% low: 4476.777 FPS (component-only inverse p99).
- WARNING — component median ratio delta: 91.9075520833333%; absolute p95 delta: 0.082144999999999996 ms.
...
- Classic median/p95: 0.000986000 / 0.001080000 ms.
- Candidate median/p95: 0.002033000 / 0.002145500 ms.
- Candidate 1% low: 407331.976 FPS (component-only inverse p99).
- WARNING — component median ratio delta: 106.18661257606487%; absolute p95 delta: 0.0010654999999999998 ms.
- Allocation classic/candidate: 280.000 / 280.000 bytes per frame.
- Model-bone instances: 700; MHLib parts: 0.

## Q6 status and exact mixed-100 warning numbers

- WARNING — mixed-100 component median ratio delta: 91.9075520833333%.
- WARNING — mixed-100 absolute component p95 delta: 0.082144999999999996 ms.
