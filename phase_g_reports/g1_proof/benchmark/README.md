...
- Captured: 2026-09-05T18:41:39.201269900Z
...
- Repository base revision: `c4cec37d2155119ef05670d580de5d177496c3dd` (working content bound by source/input hashes).
...
- Classic median/p95: 0.054690000 / 0.072395000 ms.
- Candidate median/p95: 0.130680000 / 0.170835000 ms.
- Candidate 1% low: 4704.443 FPS (component-only inverse p99).
- WARNING — component median ratio delta: 138.94679100383988%; absolute p95 delta: 0.098440000000000014 ms.
...
- Scope: renderer vertex submission only; no window, GPU, client tick, or server.
- Classic median/p95: 0.112740000 / 0.129400000 ms.
- Candidate median/p95: 0.228985000 / 0.263910000 ms.
- Candidate 1% low: 3254.467 FPS (component-only inverse p99).
- WARNING — component median ratio delta: 103.10892318609186%; absolute p95 delta: 0.13450999999999996 ms.
...
- Scope: renderer vertex submission only; no window, GPU, client tick, or server.
- Classic median/p95: 0.085970000 / 0.100700000 ms.
- Candidate median/p95: 0.178535000 / 0.207540000 ms.
- Candidate 1% low: 4469.973 FPS (component-only inverse p99).
- WARNING — component median ratio delta: 107.67128067930672%; absolute p95 delta: 0.10684 ms.
...
- Classic median/p95: 0.000991000 / 0.001124500 ms.
- Candidate median/p95: 0.002075000 / 0.002347500 ms.
- Candidate 1% low: 394944.708 FPS (component-only inverse p99).
- WARNING — component median ratio delta: 109.38446014127146%; absolute p95 delta: 0.0012229999999999997 ms.
- Allocation classic/candidate: 280.000 / 280.000 bytes per frame.
- Model-bone instances: 700; MHLib parts: 0.

## Q6 status and exact mixed-100 warning numbers

- WARNING — mixed-100 component median ratio delta: 107.67128067930672%.
- WARNING — mixed-100 absolute component p95 delta: 0.10684 ms.
