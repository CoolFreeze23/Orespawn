...
- Captured: 2026-09-24T00:48:17.321819Z
...
- Repository base revision: `f149baa0ac1eba4c2425edab19adf611e4abd267` (working content bound by source/input hashes).
...
- Classic median/p95: 0.048440000 / 0.078985000 ms.
- Candidate median/p95: 0.145635000 / 0.222775000 ms.
- Candidate 1% low: 2714.367 FPS (component-only inverse p99).
- WARNING — component median ratio delta: 200.65028901734107%; absolute p95 delta: 0.14379 ms.
...
- Scope: renderer vertex submission only; no window, GPU, client tick, or server.
- Classic median/p95: 0.112285000 / 0.158885000 ms.
- Candidate median/p95: 0.239790000 / 0.339765000 ms.
- Candidate 1% low: 2418.643 FPS (component-only inverse p99).
- WARNING — component median ratio delta: 113.55479360555729%; absolute p95 delta: 0.18087999999999999 ms.
...
- Scope: renderer vertex submission only; no window, GPU, client tick, or server.
- Classic median/p95: 0.087985000 / 0.106670000 ms.
- Candidate median/p95: 0.182960000 / 0.221120000 ms.
- Candidate 1% low: 4007.936 FPS (component-only inverse p99).
- WARNING — component median ratio delta: 107.94453600045463%; absolute p95 delta: 0.11445000000000001 ms.
...
- Classic median/p95: 0.000964000 / 0.001134000 ms.
- Candidate median/p95: 0.001983500 / 0.002342000 ms.
- Candidate 1% low: 403795.679 FPS (component-only inverse p99).
- WARNING — component median ratio delta: 105.75726141078836%; absolute p95 delta: 0.0012079999999999999 ms.
- Allocation classic/candidate: 280.000 / 280.000 bytes per frame.
- Model-bone instances: 700; MHLib parts: 0.

## Q6 status and exact mixed-100 warning numbers

- WARNING — mixed-100 component median ratio delta: 107.94453600045463%.
- WARNING — mixed-100 absolute component p95 delta: 0.11445000000000001 ms.
