...
- Captured: 2026-09-13T19:00:42.660052300Z
...
- Repository base revision: `536f33069a4a2033d97590fe383c8041b395bf23` (working content bound by source/input hashes).
...
- Classic median/p95: 0.050865000 / 0.070360000 ms.
- Candidate median/p95: 0.153840000 / 0.216620000 ms.
- Candidate 1% low: 3656.775 FPS (component-only inverse p99).
- WARNING — component median ratio delta: 202.4476555588322%; absolute p95 delta: 0.14626 ms.
...
- Scope: renderer vertex submission only; no window, GPU, client tick, or server.
- Classic median/p95: 0.110565000 / 0.132625000 ms.
- Candidate median/p95: 0.236025000 / 0.285420000 ms.
- Candidate 1% low: 3026.863 FPS (component-only inverse p99).
- WARNING — component median ratio delta: 113.47171347171346%; absolute p95 delta: 0.15279500000000001 ms.
...
- Scope: renderer vertex submission only; no window, GPU, client tick, or server.
- Classic median/p95: 0.081165000 / 0.104645000 ms.
- Candidate median/p95: 0.176570000 / 0.231200000 ms.
- Candidate 1% low: 2898.131 FPS (component-only inverse p99).
- WARNING — component median ratio delta: 117.54450810078234%; absolute p95 delta: 0.12655499999999997 ms.
...
- Classic median/p95: 0.000946000 / 0.001039500 ms.
- Candidate median/p95: 0.001976000 / 0.002196000 ms.
- Candidate 1% low: 399281.294 FPS (component-only inverse p99).
- WARNING — component median ratio delta: 108.87949260042285%; absolute p95 delta: 0.0011565 ms.
- Allocation classic/candidate: 280.000 / 280.000 bytes per frame.
- Model-bone instances: 700; MHLib parts: 0.

## Q6 status and exact mixed-100 warning numbers

- WARNING — mixed-100 component median ratio delta: 117.54450810078234%.
- WARNING — mixed-100 absolute component p95 delta: 0.12655499999999997 ms.
