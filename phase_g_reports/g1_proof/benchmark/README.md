...
- Captured: 2026-09-14T18:39:16.009783200Z
...
- Repository base revision: `ab505c135460414146eda8772d38416924dda081` (working content bound by source/input hashes).
...
- Classic median/p95: 0.050275000 / 0.064650000 ms.
- Candidate median/p95: 0.144640000 / 0.178375000 ms.
- Candidate 1% low: 4364.430 FPS (component-only inverse p99).
- WARNING — component median ratio delta: 187.69766285430131%; absolute p95 delta: 0.11372500000000001 ms.
...
- Scope: renderer vertex submission only; no window, GPU, client tick, or server.
- Classic median/p95: 0.112985000 / 0.128795000 ms.
- Candidate median/p95: 0.236280000 / 0.276440000 ms.
- Candidate 1% low: 3154.126 FPS (component-only inverse p99).
- WARNING — component median ratio delta: 109.12510510244719%; absolute p95 delta: 0.14764500000000003 ms.
...
- Scope: renderer vertex submission only; no window, GPU, client tick, or server.
- Classic median/p95: 0.083635000 / 0.097495000 ms.
- Candidate median/p95: 0.173520000 / 0.205005000 ms.
- Candidate 1% low: 3822.265 FPS (component-only inverse p99).
- WARNING — component median ratio delta: 107.47294792849883%; absolute p95 delta: 0.10750999999999999 ms.
...
- Classic median/p95: 0.000967000 / 0.001061000 ms.
- Candidate median/p95: 0.001985500 / 0.002192000 ms.
- Candidate 1% low: 427350.427 FPS (component-only inverse p99).
- WARNING — component median ratio delta: 105.32574974146844%; absolute p95 delta: 0.0011310000000000001 ms.
- Allocation classic/candidate: 280.000 / 280.000 bytes per frame.
- Model-bone instances: 700; MHLib parts: 0.

## Q6 status and exact mixed-100 warning numbers

- WARNING — mixed-100 component median ratio delta: 107.47294792849883%.
- WARNING — mixed-100 absolute component p95 delta: 0.10750999999999999 ms.
