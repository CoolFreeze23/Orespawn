...
- Captured: 2026-09-13T16:00:47.401374100Z
...
- Repository base revision: `59255fed9280be135a5c8425620df78fe802437c` (working content bound by source/input hashes).
...
- Classic median/p95: 0.050380000 / 0.111480000 ms.
- Candidate median/p95: 0.124180000 / 0.257425000 ms.
- Candidate 1% low: 2862.049 FPS (component-only inverse p99).
- WARNING — component median ratio delta: 146.48670107185393%; absolute p95 delta: 0.14594500000000002 ms.
...
- Scope: renderer vertex submission only; no window, GPU, client tick, or server.
- Classic median/p95: 0.109500000 / 0.144580000 ms.
- Candidate median/p95: 0.239560000 / 0.310745000 ms.
- Candidate 1% low: 2636.401 FPS (component-only inverse p99).
- WARNING — component median ratio delta: 118.77625570776256%; absolute p95 delta: 0.16616500000000001 ms.
...
- Scope: renderer vertex submission only; no window, GPU, client tick, or server.
- Classic median/p95: 0.085975000 / 0.108480000 ms.
- Candidate median/p95: 0.176645000 / 0.228790000 ms.
- Candidate 1% low: 3641.594 FPS (component-only inverse p99).
- WARNING — component median ratio delta: 105.46088979354464%; absolute p95 delta: 0.12031 ms.
...
- Classic median/p95: 0.000946500 / 0.001111500 ms.
- Candidate median/p95: 0.001942000 / 0.002320000 ms.
- Candidate 1% low: 366367.467 FPS (component-only inverse p99).
- WARNING — component median ratio delta: 105.17696777601691%; absolute p95 delta: 0.0012084999999999999 ms.
- Allocation classic/candidate: 280.000 / 280.000 bytes per frame.
- Model-bone instances: 700; MHLib parts: 0.

## Q6 status and exact mixed-100 warning numbers

- WARNING — mixed-100 component median ratio delta: 105.46088979354464%.
- WARNING — mixed-100 absolute component p95 delta: 0.12031 ms.
