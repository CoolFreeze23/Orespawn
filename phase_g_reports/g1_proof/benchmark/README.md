...
- Captured: 2026-09-15T13:12:28.325079900Z
...
- Repository base revision: `58c6aaf2a5e4dafff9173c9de831187f464ec0cc` (working content bound by source/input hashes).
...
- Classic median/p95: 0.044840000 / 0.054300000 ms.
- Candidate median/p95: 0.130740000 / 0.154170000 ms.
- Candidate 1% low: 4724.670 FPS (component-only inverse p99).
- WARNING — component median ratio delta: 191.57002676181983%; absolute p95 delta: 0.09987 ms.
...
- Scope: renderer vertex submission only; no window, GPU, client tick, or server.
- Classic median/p95: 0.109910000 / 0.143970000 ms.
- Candidate median/p95: 0.203655000 / 0.268070000 ms.
- Candidate 1% low: 3288.554 FPS (component-only inverse p99).
- WARNING — component median ratio delta: 85.292512055317999%; absolute p95 delta: 0.12410000000000004 ms.
...
- Scope: renderer vertex submission only; no window, GPU, client tick, or server.
- Classic median/p95: 0.081020000 / 0.102580000 ms.
- Candidate median/p95: 0.157330000 / 0.203910000 ms.
- Candidate 1% low: 4040.894 FPS (component-only inverse p99).
- WARNING — component median ratio delta: 94.186620587509239%; absolute p95 delta: 0.10132999999999998 ms.
...
- Classic median/p95: 0.001057500 / 0.001303000 ms.
- Candidate median/p95: 0.002137000 / 0.002639000 ms.
- Candidate 1% low: 286902.883 FPS (component-only inverse p99).
- WARNING — component median ratio delta: 102.08037825059107%; absolute p95 delta: 0.0013359999999999999 ms.
- Allocation classic/candidate: 280.000 / 280.000 bytes per frame.
- Model-bone instances: 700; MHLib parts: 0.

## Q6 status and exact mixed-100 warning numbers

- WARNING — mixed-100 component median ratio delta: 94.186620587509239%.
- WARNING — mixed-100 absolute component p95 delta: 0.10132999999999998 ms.
