...
public interface IMHLibFieldAccessor<T extends LivingEntity> {
    ...
    // ──────────────────────────────────────────────────────────────────
    // OPT-003: client-side change-only bone-streaming state backing
    // fields (see IMultipartEntity.updateSynching for the throttle and
    // its invalidation story). The last-sent map is the
    ...
    // ──────────────────────────────────────────────────────────────────
    // BUG-044: per-entity render-tick stamp backing field for the
    // client bone-collection gate (util.RenderTickGate; decided once
    // per render pass in
