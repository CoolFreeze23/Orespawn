...
/**
 * BUG-044: the once-per-game-tick gate of the client bone collection, keyed on a PER-ENTITY
 * render-tick stamp -- the last {@code Entity.tickCount} a collecting render pass ran for that
 * entity, {@link #UNSTAMPED} until the first one ({@code IMHLibFieldAccessor
