    ...
    public static final DeferredHolder<CreativeModeTab, CreativeModeTab> BLOCKS_TAB =
            CREATIVE_MODE_TABS.register("orespawn_blocks", () -> CreativeModeTab.builder()
                    ...
                    .displayItems((parameters, output) -> {
                        ...
                        // WGEN-023 — crystal spawn-block egg ores
                        output.accept(ModItems.ORE_URCHIN_ITEM.get());
                        output.accept(ModItems.ORE_FLOUNDER_ITEM.get());
                        output.accept(ModItems.ORE_SKATE_ITEM.get());
                        output.accept(ModItems.ORE_ROTATOR_ITEM.get());
                        output.accept(ModItems.ORE_PEACOCK_ITEM.get());
                        output.accept(ModItems.ORE_FAIRY_ITEM.get());
                        output.accept(ModItems.ORE_DUNGEON_BEAST_ITEM.get());
                        output.accept(ModItems.ORE_VORTEX_ITEM.get());
                        output.accept(ModItems.ORE_RAT_ITEM.get());
                        output.accept(ModItems.ORE_WHALE_ITEM.get());
                        output.accept(ModItems.ORE_IRUKANDJI_ITEM.get());
                        // Phase D5 (WGEN-005) — restored SpawnOres pool (original
                        // creative tab was Building Blocks, orig OreGenericEgg.java:21)
    ...
    public static final DeferredHolder<CreativeModeTab, CreativeModeTab> SPAWN_EGGS_TAB =
            CREATIVE_MODE_TABS.register("orespawn_spawn_eggs", () -> CreativeModeTab.builder()
                    ...
                    .displayItems((parameters, output) -> {
                        ...
                        // Phase E decision (2026-08-11): wiki-only mobs' eggs
                        // are creative-visible only with phase14ContentEnable
                        // on -- the EFFECTIVE value, [modern] enabled AND
