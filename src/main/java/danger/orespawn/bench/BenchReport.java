 ...
 *
 * <p>review (2026-09-06): every metric that can be undefined (no client, no samples, a zero
...
public final class BenchReport {
    ...
    public static JsonObject build(BenchServerResult server, BenchClientSnapshot client, String label, String gitHead,
        ...
        threshold.addProperty("status", "PROPOSED, NOT ADOPTED -- undecided; nothing here gates");
    ...
    public static JsonObject pairing(JsonObject report, JsonObject other) {
        ...
        out.addProperty("note", "information for a later decision; the proposed rule shape is in threshold_proposal.md and nothing is gated");
        return out;
    }
