...
/**
 * ENT-S-121 — the port-wide line-of-sight convention (decision of 2026-09-04: "adopt the 1.7.10 convention
...
public final class OreSpawnSight {
     ...
     *  answer unseen, and no hunter of the port scans that far (ENT-S-121). */
