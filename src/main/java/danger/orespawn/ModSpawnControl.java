    ...
    private static Map<EntityType<?>, Supplier<Boolean>> getSpawnControls() {
        if (spawnControls == null) {
            spawnControls = Map.ofEntries(
                    ...
                    // spawns additionally require phase14ContentEnable, read
                    // as its EFFECTIVE value ([modern] enabled AND the
                    // key, via OreSpawnConfig.phase14ContentEnable;
                    // master-override). EnchantedAppleCow
