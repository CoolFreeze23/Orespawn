...
public class ItemOreSpawnArmor extends ArmorItem {
    ...
    public void inventoryTick(ItemStack stack, Level level, Entity entity, int slotId, boolean isSelected) {
        ...
        // OPT-022 (applied 2026-08-11 — 20-TICK-GATE variant): the
        ...
        // <=1 s (<=20 ticks) before the poll lands — accepted by the
        // decision. The finding's alternative, migrating the
        // enchant to onCraftedBy/first-pickup, was REJECTED by the same
        // decision: it would change WHEN loot-table, creative-given, and
        // pre-existing stacks get enchanted, and this poll is the
