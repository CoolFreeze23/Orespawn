...
public class Chainsaw extends UltimateSword {
     ...
     * mapping the port had carried unrecorded (ITEM-070, option B2 2026-09-05).
     */
     ...
     * sweeps nothing (ITEM-070's row 10, kept as decided). The argument order is the port's ({@code (player, e)}); orig's
     * was {@code (e, player)}. ITEM-070 (B2, 2026-09-05): the classic sight; modern keeps the vanilla ray under MOD-037.
     */
