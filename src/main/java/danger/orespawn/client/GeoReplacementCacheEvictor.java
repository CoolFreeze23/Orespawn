 ...
 * {@code updateLevelInEngines} call (57 / 211). One level drop posts NO
 * unload: {@code Minecraft.clearClientLevel(Screen)} — reached from {@code
 * ClientPacketListener.handleConfigurationStart} (offset 55; a server-driven
