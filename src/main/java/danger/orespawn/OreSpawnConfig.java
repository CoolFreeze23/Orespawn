...
public class OreSpawnConfig {
    ...
    // phase14ContentEnable(), mothraWideRootHitbox()), never through the
    // keys directly. The MOD-024 items are unimplemented proposals, not
    // keys.
    //
    //
    //
     ...
     * #phase14ContentEnable()}, {@link #mothraWideRootHitbox()} -- a
