...
public class OreSpawnConfig {
    ...
    /**
     * MOD-038 (Phase G, the standard animation contract; scope; the gate as
     * decided 2026-09-12): artist keyframe animations on the GeckoLib candidate
     * renderers -- a species whose {@code .animation.json} carries the
     * contract's {@code idle} AND {@code walk} clips together (plus the group clips)
     * registers the contract's phase-locked layers and its code-driven classic pose
     * hook stands down; one without the other, or neither (the Beaver ships its
     * transcription since 2026-09-12, every other shipped clip file is empty), keeps
     * the classic pose whatever this says. Takes effect only while {@link
     * #MODERN_ENABLED} is on -- read through {@link
