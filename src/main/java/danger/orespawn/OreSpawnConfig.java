...
public class OreSpawnConfig {
     ...
     * #fireRespectsMobGriefing()} -- a feature's key is never
     * consulted without this master. Phase G artist
     * animations will hang off this same master. Construction-snapshotted
     * features (the robot gait mode, the hitbox sub-keys; BOSS-017
     * pattern) see a flip on newly constructed/loaded entities only, not
     * live ones.
     *
     */
