...
/**
 * GeckoLib Water Dragon (the hooks, owner 2026-09-14, addendum item 10): {@link ModelWaterDragon#poseFrom} verbatim on
 * the rig the landing slice converts, ON THE HOOK (Amendment 2 to Amendment 1: no keyframe layer, no transcription -
 * the self-gate stays closed until an artist delivers {@code idle} and {@code walk}). Wingspeed 0.5f (orig
 * ModelWaterDragon.java:14,41 / ClientProxyOreSpawn.java:436): the THRESHOLD idiom on the four legs about Y - above a
 * walking speed of a tenth {@code cos(age x 1.3 x ws) x PI x 0.2 x limbSwingAmount} about +-0.58 rad, 0 at or below it
