...
public class AlosaurusRenderer extends MobRenderer<Alosaurus, ModelAlosaurus> {
    ...
    public static final ModelLayerLocation MODEL_LAYER =
            new ModelLayerLocation(ResourceLocation.fromNamespaceAndPath(OreSpawnMod.MOD_ID, "alosaurus"), "main");

    private static final float SCALE = 1.0f;

    public AlosaurusRenderer(EntityRendererProvider.Context context) {
        super(context, new ModelAlosaurus(context.bakeLayer(MODEL_LAYER)), 1.0f);
    }

    @Override
    public void render(Alosaurus entity, float entityYaw, float partialTicks,
