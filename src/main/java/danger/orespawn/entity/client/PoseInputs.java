 ...
 *
 * <p>THE PARTIAL TICK (the remainder slice - TEST-010 (b)): the classic {@code LivingEntityRenderer.render} sets two
 * model fields from the FRAME's partial tick before {@code setupAnim}
 *
