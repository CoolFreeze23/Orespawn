...
public class FairyModel extends EntityModel<Fairy> {
    ...
    public static LayerDefinition createBodyLayer() {
        ...
        partdefinition.addOrReplaceChild("larm",
                CubeListBuilder.create().texOffs(7, 14)
