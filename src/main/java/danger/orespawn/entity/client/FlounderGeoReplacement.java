 ...
 * 0.25f * limbSwingAmount} and {@code cos(age * 1.7f) * PI * 0.25f * limbSwingAmount} and the two tail parts pitch on a
 * 1.2 cosine x 0.25 x limbSwingAmount; at or below it the fins hold 0 and the tail sways on a 0.7 cosine x 0.05 (orig
 * :91-103).
 *
