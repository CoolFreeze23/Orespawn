 ...
 * delivers {@code idle} and {@code walk}). The port's classic model as it is: the HEAD-LOOK idiom (head and beak yaw
 * by {@code netHeadYaw} in radians) and the wings' {@code |cos|} idiom ({@code |cos(age * 1.0f) * PI *
 * 0.15f|}, mirrored about Z; orig ModelRubberDucky.java:88, :91, :111-114 for the lines the port keeps - the
 * register line of this slice records where the port's pose departs from the 1.7.10 one).
 *
