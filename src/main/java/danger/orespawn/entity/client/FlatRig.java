 ...
 * and; design section 5: the Alien and the Emperor Scorpion become real parent-child bone hierarchies rather than flat
 * rigs whose child pivots the classic code rewrites by trigonometry).
 *
 *
 ...
 * classic's either way, which is the decision's proof, not a re-authored rig.</p>
 *
