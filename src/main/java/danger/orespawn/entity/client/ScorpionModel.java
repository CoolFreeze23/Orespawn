...
/**
 * BUG-041 stage 2 (2026-09-13): the 1.7.10 export sets {@code mirror = true} AFTER {@code addBox} (orig ModelScorpion.java:
...
public class ScorpionModel extends EntityModel<EntityScorpion> {
    ...
    /** The classic pose over what the model reads from its entity (orig ModelScorpion.java:198 {@code getRenderInfo()}, :203 {@code getAttacking()}, :204-208 the random source). */
    public void poseFrom(ScorpionPose entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
        float newangle = 0.0f;
        float upangle = 0.0f;
