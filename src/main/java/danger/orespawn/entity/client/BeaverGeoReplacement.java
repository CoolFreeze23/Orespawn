 ...
 * classic renderer to within float rounding (). No keyframe clip is involved,
 * so no approximation tolerance applies. Motion only becomes
 * artist-editable once undecided on a keyframe tolerance.</p>
 */
