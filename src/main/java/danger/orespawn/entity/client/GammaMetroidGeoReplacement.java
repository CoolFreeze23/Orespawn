 ...
 * delivers {@code idle} and {@code walk}). The port's classic model as it is: the three tusks about X at 0.81
 * rad/tick, the first shell at 0.4 (a quarter of its swing) and the lower beak's {@code |cos|} idiom at 0.75
 * plus 0.14 rad (orig ModelGammaMetroid.java:175, :193-197, :204-206 for the lines the port keeps; the port's model
 * carries no wingspeed multiply - the register line of this slice records where the port's pose departs from the
 * 1.7.10 one).
 *
