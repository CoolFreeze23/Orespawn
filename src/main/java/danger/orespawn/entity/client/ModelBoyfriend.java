...
public class ModelBoyfriend extends EntityModel<Boyfriend> {
    ...
    public static LayerDefinition createBodyLayer() {
        ...
        root.addOrReplaceChild("right_arm", CubeListBuilder.create().texOffs(24, 16).addBox(-3.0F, -2.0F, -2.0F, 4, 12, 4), PartPose.offset(-5.0F, 2.0F, 0.0F));
    ...
    @Override
    public void setupAnim(Boyfriend entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
