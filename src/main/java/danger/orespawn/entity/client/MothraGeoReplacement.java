...
/**
 * GeckoLib Mothra (the hook lanes, 2026-09-14): a consumer of the Butterfly rig. orig ClientProxyOreSpawn.java:411
 * registers {@code new RenderButterfly(new ModelButterfly(0.2f), 0.75f, 10.0f)} over the eye-moth sheet, so this
 * descriptor shares {@link ButterflyGeoReplacement}'s geo, clip file and hook under its own registry path
 * ({@code mothra}; one profile per registry path even for a shared rig) at Mothra's own wingspeed 0.2f.
 *
