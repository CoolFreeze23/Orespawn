...
/**
 * BUG-041 stage 2 (2026-09-13): the 1.7.10 export sets {@code mirror = true} AFTER {@code addBox} (orig ModelThePrinceAdult.java:
 * 119 stores, all inert - 1.7.10's ModelBox reads the flag in its constructor, law 11 from Mojang's 1.7.10 jar),
 * so the original rendered UNMIRRORED. The port's 119 {@code .mirror()} calls preceded {@code addBox} and flipped
...
public class ModelThePrinceAdult extends EntityModel<ThePrinceAdult> {
    ...
    public void setupAnim(ThePrinceAdult entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
        ...
        if (entity.getAttacking() != 0) {
            newangle = Mth.cos(ageInTicks * 0.75F * this.wingspeed) * (float) Math.PI * 0.21F;
        } else {
            newangle = Mth.cos(ageInTicks * 0.35F * this.wingspeed) * (float) Math.PI * 0.15F;
            if (entity.getActivity() == 0) {
                newangle = Mth.cos(ageInTicks * 0.35F * this.wingspeed) * (float) Math.PI * 0.15F * limbSwingAmount;
            }
        }
        ...
        newangle = 0.0F;
        if (entity.getAttacking() != 0) {
            newangle = Mth.cos(ageInTicks * 0.75F * this.wingspeed) * (float) Math.PI * 0.25F;
        }
        ...
        newangle = 0.0F;
        if (entity.getAttacking() != 0) {
            newangle = Mth.cos(ageInTicks * 0.6F * this.wingspeed) * (float) Math.PI * 0.45F;
        } else if (!entity.isOrderedToSit() && entity.getActivity() == 0) {
            newangle = Mth.cos(ageInTicks * 0.3F * this.wingspeed) * (float) Math.PI * 0.25F * limbSwingAmount;
        }
        ...
        this.Ridge4.yRot = this.Ridge5.yRot = (this.Tail1.yRot = Mth.cos(ageInTicks * tailspeed * this.wingspeed) * (float) Math.PI * tailamp / 2.0F);
        ...
        if (entity.getAttacking() != 0) {
            Lheadlr = Mth.sin(ageInTicks * 0.3F * this.wingspeed) * (float) Math.PI * 0.25F;
            Lheadud = (float) Math.toRadians(entity.getHead1Ext() - 30);
            Ljawangle = Mth.sin(ageInTicks * 0.85F * this.wingspeed) * (float) Math.PI * 0.12F;
            Rheadlr = Mth.sin(ageInTicks * 0.32F * this.wingspeed) * (float) Math.PI * 0.25F;
            Rheadud = (float) Math.toRadians(entity.getHead3Ext() - 30);
            Rjawangle = Mth.sin(ageInTicks * 0.95F * this.wingspeed) * (float) Math.PI * 0.12F;
            Cheadlr = Mth.sin(ageInTicks * 0.28F * this.wingspeed) * (float) Math.PI * 0.25F;
            Cheadud = (float) Math.toRadians(entity.getHead2Ext() - 30);
            Cjawangle = Mth.sin(ageInTicks * 0.75F * this.wingspeed) * (float) Math.PI * 0.12F;
            Ljawangle += 0.5F;
            Ljawangle += Lheadud;
            Cjawangle += 0.5F;
            Cjawangle += Cheadud;
            ...
            if (entity.getActivity() != 0) {
                Lheadlr = Mth.sin(ageInTicks * 0.17F * this.wingspeed) * (float) Math.PI * 0.08F;
                Lheadud = (float) Math.toRadians(entity.getHead1Ext() - 30);
                Ljawangle = Mth.sin(ageInTicks * 0.45F * this.wingspeed) * (float) Math.PI * 0.04F;
                Rheadlr = Mth.sin(ageInTicks * 0.19F * this.wingspeed) * (float) Math.PI * 0.08F;
                Rheadud = (float) Math.toRadians(entity.getHead3Ext() - 30);
                Rjawangle = Mth.sin(ageInTicks * 0.55F * this.wingspeed) * (float) Math.PI * 0.04F;
                Cheadlr = Mth.sin(ageInTicks * 0.13F * this.wingspeed) * (float) Math.PI * 0.08F;
                Cheadud = (float) Math.toRadians(entity.getHead2Ext() - 30);
                Cjawangle = Mth.sin(ageInTicks * 0.65F * this.wingspeed) * (float) Math.PI * 0.04F;
            } else {
                Lheadud = (float) Math.toRadians(entity.getHead1Ext() - 30);
                Rheadud = (float) Math.toRadians(entity.getHead3Ext() - 30);
                Cheadud = (float) Math.toRadians(entity.getHead2Ext() - 30);
                ...
                Ljawangle = Mth.sin(ageInTicks * 0.25F * this.wingspeed) * (float) Math.PI * 0.03F;
                Rjawangle = Mth.sin(ageInTicks * 0.35F * this.wingspeed) * (float) Math.PI * 0.03F;
                Cjawangle = Mth.sin(ageInTicks * 0.45F * this.wingspeed) * (float) Math.PI * 0.03F;
            }
            Ljawangle += 0.25F;
            Ljawangle += Lheadud;
            Cjawangle += 0.25F;
    ...
    private void moveLeftHead(float Lheadlr, float Lheadud, float Ljawangle) {
        ...
        this.LJaw1.z += (float) Math.sin(this.LHead1.xRot) * 12.0F;
        this.LJaw1.x = (float) ((double) this.LHead1.x - Math.sin(this.LHead1.yRot) * 7.0);
    ...
    private void moveCenterHead(float Cheadlr, float Cheadud, float Cjawangle) {
        ...
        this.CJaw1.z += (float) Math.sin(this.CHead1.xRot) * 12.0F;
        this.CJaw1.x = (float) ((double) this.CHead1.x - Math.sin(this.CHead1.yRot) * 7.0);
    ...
    private void moveRightHead(float Rheadlr, float Rheadud, float Rjawangle) {
        ...
        this.RJaw1.z += (float) Math.sin(this.RHead1.xRot) * 12.0F;
        this.RJaw1.x = (float) ((double) this.RHead1.x - Math.sin(this.RHead1.yRot) * 7.0);
