 ...
 * legs and two feet pitch on {@code cos(age * 2.6f * ws) * PI * 0.15f * limbSwingAmount} (the right pair the negative) and
 * the ears on {@code cos(age * 1.3f * ws) * PI * 0.1f * limbSwingAmount}; at or below it the legs hold 0 and the ears
 * twitch on the same 1.3 ws cosine x 0.01 (orig :151-167); the ears around -0.226 / -0.418 rad, the right one the negative.
 *
