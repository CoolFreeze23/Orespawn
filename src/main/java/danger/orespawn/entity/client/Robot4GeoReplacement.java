 ...
 * (Tier 3, code-driven), including the cannon assembly's pivot follow
 * (position writes) and the client-local {@code setShielding} side effect kept
 * bug-for-bug (ENT-K-070), with {@link Robot4Renderer}'s 1.0 x 1.0 shadow
