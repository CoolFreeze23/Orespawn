...
public final class ThePrinceTeenGeoReplacement extends OreSpawnGeoReplacement<ThePrinceTeen> {
    ...
    /** The SPEC's {@code locomotion: flyer} (tools/artist_specs/the_prince_teen.json): {@code flying} is {@code !onGround()} (contract section 3; the weights slice: every landed species carries its seed's word, the asset audit pins it). */
    @Override
