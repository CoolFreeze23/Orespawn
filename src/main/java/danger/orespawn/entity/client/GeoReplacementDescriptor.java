...
public abstract class GeoReplacementDescriptor<E extends Entity> {
     ...
     * by construction).
     *
     * <p>THE ORDER ANALYSIS (TEST-013; the frame from the bytecode of NeoForge 21.1.223 and GeckoLib 4.8.4, refuter B of
     * the harness-and-seam landing): the classic path applies its rotation INSIDE {@code renderToBuffer}, after
