...
public class StinkBugModel<T extends EntityStinkBug> extends EntityModel<T> {
    ...
    public static LayerDefinition createBodyLayer() {
        ...
        root.addOrReplaceChild("body", CubeListBuilder.create().texOffs(0, 0)
                .addBox(-4.0F, -2.0F, -4.0F, 8, 4, 8), PartPose.offset(0.0F, 20.0F, 0.0F));
        root.addOrReplaceChild("head", CubeListBuilder.create().texOffs(0, 12)
                .addBox(-2.0F, -2.0F, -3.0F, 4, 3, 3), PartPose.offset(0.0F, 19.5F, -4.0F));

        root.addOrReplaceChild("leg1", CubeListBuilder.create().texOffs(0, 18)
                .addBox(-0.5F, 0.0F, -0.5F, 1, 3, 1), PartPose.offset(-3.5F, 22.0F, -2.5F));
        root.addOrReplaceChild("leg2", CubeListBuilder.create().texOffs(0, 18)
                .addBox(-0.5F, 0.0F, -0.5F, 1, 3, 1), PartPose.offset(3.5F, 22.0F, -2.5F));
        root.addOrReplaceChild("leg3", CubeListBuilder.create().texOffs(0, 18)
                .addBox(-0.5F, 0.0F, -0.5F, 1, 3, 1), PartPose.offset(-3.5F, 22.0F, 0.0F));
        root.addOrReplaceChild("leg4", CubeListBuilder.create().texOffs(0, 18)
                .addBox(-0.5F, 0.0F, -0.5F, 1, 3, 1), PartPose.offset(3.5F, 22.0F, 0.0F));
        root.addOrReplaceChild("leg5", CubeListBuilder.create().texOffs(0, 18)
                .addBox(-0.5F, 0.0F, -0.5F, 1, 3, 1), PartPose.offset(-3.5F, 22.0F, 2.5F));
        root.addOrReplaceChild("leg6", CubeListBuilder.create().texOffs(0, 18)
                .addBox(-0.5F, 0.0F, -0.5F, 1, 3, 1), PartPose.offset(3.5F, 22.0F, 2.5F));

        root.addOrReplaceChild("antenna_left", CubeListBuilder.create().texOffs(14, 12)
                .addBox(-0.5F, -4.0F, 0.0F, 1, 4, 0), PartPose.offset(-1.0F, 18.0F, -7.0F));
        root.addOrReplaceChild("antenna_right", CubeListBuilder.create().texOffs(16, 12)
                .addBox(-0.5F, -4.0F, 0.0F, 1, 4, 0), PartPose.offset(1.0F, 18.0F, -7.0F));
