 ...
 * {@code walk}, its delta scaled by {@code limbSwingAmount}; the jaws' is {@code walk_jaws}, always on. The leg
 * parts bind rotated about Y and Z and animate about X, so their keys are deltas from a zero X bind.
 *
