...
/**
 * GeckoLib Crab (the hooks, landed by the fourth Tier-2 slice T2d, with the draw fix): the classic {@link ModelCrab}
 * pose verbatim on the render-instance-expanded rig, ON THE HOOK (no keyframe layer, no transcription - the self-gate
 * stays closed until an artist delivers {@code idle} and {@code walk}). No wingspeed (orig ModelCrab.java has none).
 *
 *
