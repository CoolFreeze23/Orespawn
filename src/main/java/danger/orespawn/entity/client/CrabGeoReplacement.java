...
/**
 * GeckoLib Crab (the hooks): {@link ModelCrab#poseFrom} verbatim on the render-instance-expanded rig, ON
 * THE HOOK (no keyframe layer, no transcription - the self-gate stays closed until an artist delivers {@code idle}
 * and {@code walk}). No wingspeed (orig ModelCrab.java has none).
 *
 *
