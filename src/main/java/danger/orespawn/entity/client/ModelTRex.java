...
/**
 * BUG-041 stage 2 (2026-09-13): the 1.7.10 export sets {@code mirror = true} AFTER {@code addBox} (orig ModelTRex.java:
...
public class ModelTRex extends EntityModel<TRex> {
    ...
    /** The classic pose over what the model reads from its entity (the port's {@code entity.getAttacking() != 0}; orig ModelTRex.java setRotationAngles). */
    public void poseFrom(TRexPose entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
