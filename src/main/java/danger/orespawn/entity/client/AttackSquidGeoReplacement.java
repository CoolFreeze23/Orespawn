 ...
 * {@code PI * 0.4 * limbSwingAmount} on their own frequencies (1.2 / 1.1 / 1.0 / 1.9 / 1.8 / 1.7 / 1.6 / 1.5 ws) and the
 * body pitches and rolls at {@code PI * 0.04 * limbSwingAmount} on 0.25 / 0.39 ws; at or below it the same frequencies
 * at {@code PI * 0.1} and {@code PI * 0.01} - around the tentacles' rests (-1.03 / 0.37 / 0.6 / -0.48 / 0.63 / -0.26 /
 * -1.03 / 0.43; two about Z, six about X); and the HEAD-LOOK idiom, the body yawing {@code toRadians(netHeadYaw) *
 * 0.75}. No entity state.
 *
