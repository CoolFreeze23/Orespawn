...
public final class PurplePowerGeoReplacement extends OreSpawnGeoReplacement<PurplePower> {
    ...
    /** The SPEC's {@code locomotion: flyer} (tools/artist_specs/purple_power.json): {@code flying} is {@code !onGround()} (contract section 3; the weights slice: every landed species carries its seed's word, the asset audit pins it). */
    @Override
