...
public class KyuubiModel extends EntityModel<EntityKyuubi> {
    ...
    public void setupAnim(EntityKyuubi entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
        float newangle = 0.0f;
        newangle = (double)limbSwingAmount > 0.1 ? Mth.cos((float)(ageInTicks * 1.1f * this.wingspeed)) * (float)Math.PI * 0.2f * limbSwingAmount : 0.0f;
        ...
        newangle = Mth.cos((float)(ageInTicks * 1.1f * this.wingspeed)) * (float)Math.PI * 0.08f * limbSwingAmount;
        this.rtArmUpper.xRot = newangle += Mth.cos((float)(ageInTicks * 0.5f * this.wingspeed)) * (float)Math.PI * 0.01f;
        ...
        this.lfHorn1.yRot = this.headFire.yRot + 0.244f + Mth.cos((float)(ageInTicks * 1.3f * this.wingspeed)) * (float)Math.PI * 0.1f;
        ...
        this.lfHorn2.yRot = this.headFire.yRot + 0.244f + Mth.cos((float)(ageInTicks * 1.3f * this.wingspeed - pi4)) * (float)Math.PI * 0.1f;
        ...
        this.lfHorn3.yRot = this.headFire.yRot + 0.244f + Mth.cos((float)(ageInTicks * 1.3f * this.wingspeed - 2.0f * pi4)) * (float)Math.PI * 0.1f;
        ...
        this.lfHorn4.yRot = this.headFire.yRot + 0.244f + Mth.cos((float)(ageInTicks * 1.3f * this.wingspeed - 3.0f * pi4)) * (float)Math.PI * 0.1f;
        ...
        this.lfHorn5.yRot = this.headFire.yRot + 0.244f + Mth.cos((float)(ageInTicks * 1.3f * this.wingspeed - 4.0f * pi4)) * (float)Math.PI * 0.1f;
        ...
        this.rtHorn1.yRot = this.headFire.yRot + -0.244f - Mth.cos((float)(ageInTicks * 1.3f * this.wingspeed)) * (float)Math.PI * 0.1f;
        ...
        this.rtHorn2.yRot = this.headFire.yRot + -0.244f - Mth.cos((float)(ageInTicks * 1.3f * this.wingspeed - pi4)) * (float)Math.PI * 0.1f;
        ...
        this.rtHorn3.yRot = this.headFire.yRot + -0.244f - Mth.cos((float)(ageInTicks * 1.3f * this.wingspeed - 2.0f * pi4)) * (float)Math.PI * 0.1f;
        ...
        this.rtHorn4.yRot = this.headFire.yRot + -0.244f - Mth.cos((float)(ageInTicks * 1.3f * this.wingspeed - 3.0f * pi4)) * (float)Math.PI * 0.1f;
        ...
        this.rtHorn5.yRot = this.headFire.yRot + -0.244f - Mth.cos((float)(ageInTicks * 1.3f * this.wingspeed - 4.0f * pi4)) * (float)Math.PI * 0.1f;
        this.tail1.yRot = Mth.cos((float)(ageInTicks * 0.9f * this.wingspeed)) * (float)Math.PI * 0.2f;
        this.tail2.x = this.tail1.x - (float)Math.sin(this.tail1.yRot) * 3.0f;
        this.tail2.yRot = Mth.cos((float)(ageInTicks * 0.9f * this.wingspeed - pi4)) * (float)Math.PI * 0.2f;
        this.tail3.x = this.tail2.x - (float)Math.sin(this.tail2.yRot) * 4.0f;
        this.tail3.yRot = Mth.cos((float)(ageInTicks * 0.9f * this.wingspeed - 2.0f * pi4)) * (float)Math.PI * 0.2f;
        this.tail4.x = this.tail3.x - (float)Math.sin(this.tail3.yRot) * 3.5f;
        this.tail4.yRot = Mth.cos((float)(ageInTicks * 0.9f * this.wingspeed - 3.0f * pi4)) * (float)Math.PI * 0.2f;
        this.tail5.x = this.tail4.x - (float)Math.sin(this.tail4.yRot) * 5.0f;
        this.tail5.yRot = Mth.cos((float)(ageInTicks * 0.9f * this.wingspeed - 4.0f * pi4)) * (float)Math.PI * 0.2f;
        this.tail6.x = this.tail5.x - (float)Math.sin(this.tail5.yRot) * 4.0f;
        this.tail6.yRot = Mth.cos((float)(ageInTicks * 0.9f * this.wingspeed - 5.0f * pi4)) * (float)Math.PI * 0.2f;
        this.tail7.x = this.tail6.x - (float)Math.sin(this.tail6.yRot) * 3.0f;
        this.tail7.yRot = Mth.cos((float)(ageInTicks * 0.9f * this.wingspeed - 6.0f * pi4)) * (float)Math.PI * 0.2f;
        this.tail8.x = this.tail7.x - (float)Math.sin(this.tail7.yRot) * 2.0f;
        this.tail8.yRot = Mth.cos((float)(ageInTicks * 0.9f * this.wingspeed - 7.0f * pi4)) * (float)Math.PI * 0.2f;
        this.tail9.x = this.tail8.x - (float)Math.sin(this.tail8.yRot) * 1.0f;
        this.tail9.yRot = Mth.cos((float)(ageInTicks * 0.9f * this.wingspeed - 8.0f * pi4)) * (float)Math.PI * 0.2f;
        this.tail1.xRot = -0.26f + Mth.cos((float)(ageInTicks * 0.5f * this.wingspeed)) * (float)Math.PI * 0.1f;
        ...
        this.tail2.xRot = -0.78f + Mth.cos((float)(ageInTicks * 0.5f * this.wingspeed - pi4)) * (float)Math.PI * 0.1f;
        ...
        this.tail3.xRot = -1.11f + Mth.cos((float)(ageInTicks * 0.5f * this.wingspeed - 2.0f * pi4)) * (float)Math.PI * 0.1f;
        ...
        this.tail4.xRot = -0.18f + Mth.cos((float)(ageInTicks * 0.5f * this.wingspeed - 3.0f * pi4)) * (float)Math.PI * 0.1f;
        ...
        this.tail5.xRot = 0.22f + Mth.cos((float)(ageInTicks * 0.5f * this.wingspeed - 4.0f * pi4)) * (float)Math.PI * 0.1f;
        ...
        this.tail6.xRot = 0.63f + Mth.cos((float)(ageInTicks * 0.5f * this.wingspeed - 5.0f * pi4)) * (float)Math.PI * 0.1f;
        ...
        this.tail7.xRot = 0.89f + Mth.cos((float)(ageInTicks * 0.5f * this.wingspeed - 6.0f * pi4)) * (float)Math.PI * 0.1f;
        ...
        this.tail8.xRot = 1.52f + Mth.cos((float)(ageInTicks * 0.5f * this.wingspeed - 7.0f * pi4)) * (float)Math.PI * 0.1f;
        ...
        this.tail9.xRot = 2.0f + Mth.cos((float)(ageInTicks * 0.5f * this.wingspeed - 8.0f * pi4)) * (float)Math.PI * 0.1f;
    }
