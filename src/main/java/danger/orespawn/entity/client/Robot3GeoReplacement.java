 ...
 * (Tier 3, code-driven), including the per-entity {@link
 * RenderInfo} cosine zero-crossing latch, with {@link Robot3Renderer}'s 0.5
 * render scale and its 1.0 x 0.5 shadow (ENT-S-092, from
