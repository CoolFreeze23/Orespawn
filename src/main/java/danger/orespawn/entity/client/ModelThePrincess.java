...
public class ModelThePrincess extends EntityModel<ThePrincess> {
    ...
    public static LayerDefinition createBodyLayer() {
        ...
        part.addOrReplaceChild("Rjaw", CubeListBuilder.create().texOffs(30, 90).mirror()
                .addBox(-1.5f, 1.0f, -5.0f, 3, 1, 5), PartPose.offsetAndRotation(-4.5f, 7.0f, -7.0f, 0.2443461f, 0.0f, 0.0f));
        part.addOrReplaceChild("Lpower", CubeListBuilder.create().texOffs(30, 100).mirror()
                .addBox(-2.0f, -2.0f, -2.0f, 4, 4, 4), PartPose.offset(4.5f, 17.0f, -5.0f));
        part.addOrReplaceChild("Cpower", CubeListBuilder.create().texOffs(50, 100).mirror()
                .addBox(-2.0f, -2.0f, -2.0f, 4, 4, 4), PartPose.offset(0.0f, 17.0f, -5.0f));
        part.addOrReplaceChild("Rpower", CubeListBuilder.create().texOffs(70, 100).mirror()
                .addBox(-2.0f, -2.0f, -2.0f, 4, 4, 4), PartPose.offset(-4.5f, 17.0f, -5.0f));
