 ...
 * rig (Tier 3 per decision 2 of 2026-09-02). The pose is pure visibility:
 * one of five part sets is shown for the entity's rock type, and the
 * texture is the classic renderer's per-type table. Shadow is {@link
 * RockBaseRenderer#SHADOW} (0.0 x 1.0 = none, ENT-S-092, from ClientProxyOreSpawn.java:505 / RenderRockBase.java:34).
 */
