 ...
 * group's is {@link #walkClip} ({@code walk_<group>}) - and a species with ONE frequency group
 * has only the bare names (contract section 2.1), so its one group's clip is {@link #WALK} whether
 * or not it is gait-scaled (the first Tier-2 slice, 2026-09-13).
 *
