...
/**
 * BUG-041 stage 2 (2026-09-13): the 1.7.10 export sets {@code mirror = true} AFTER {@code addBox} (orig ModelMolenoid.java:
...
public class MolenoidModel extends EntityModel<EntityMolenoid> {
    ...
    /** The classic pose over what the model reads from its entity (orig ModelMolenoid.java:286 {@code getAttacking()}). */
    public void poseFrom(MolenoidPose entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
        float newangle = 0.0f;
