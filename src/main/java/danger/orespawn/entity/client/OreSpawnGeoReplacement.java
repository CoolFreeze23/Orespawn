 ...
 * TEST-015 (owner 2026-09-15, closing set continued, second, item 35 (1)) and
 * proven geometrically by the Slice 4b harness fixture
 * ({@code fixture_runtime_basis_yz}, see FIX_LOG "PHASE G SLICE 4b") and by the
 * animation leg of every landed hook (0 rad against the classic model):</p>
 * <ul>
