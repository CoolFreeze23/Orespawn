 ...
 * (Tier 3, code-driven), with {@link CoinRenderer}'s 0.125 render scale
 * and its 0.75 x 0.125 shadow (BUG-040 fix, proven against the 1.7.10
 * source by the reference-geometry leg).
 */
