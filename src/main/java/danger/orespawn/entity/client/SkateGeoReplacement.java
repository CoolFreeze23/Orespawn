 ...
 * and {@code walk}). One channel with the THRESHOLD idiom (orig ModelSkate.java:48-49): above a walking
 * speed of a tenth the tail tip pitches by {@code cos(age * 1.2f) * PI * 0.15f
 * * limbSwingAmount}, at or below it by the slow {@code cos(age * 0.4f) * PI * 0.05f}, about a 0.785 rad rest (the
 * Cricket, and this rig with it, lands under the threshold as the code has it - no {@code limb_swing_threshold}
 * property).
 *
