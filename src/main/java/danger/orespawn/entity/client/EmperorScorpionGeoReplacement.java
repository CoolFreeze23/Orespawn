...
/**
 * GeckoLib Emperor Scorpion (the hook survey): {@link EmperorScorpionModel#poseFrom} verbatim on the converted
 * rig, ON THE HOOK (no keyframe layer, no transcription - the self-gate stays closed until an artist delivers {@code
 * idle} and {@code walk}). Wingspeed 0.22f (orig ModelEmperorScorpion.java:15,96 /
