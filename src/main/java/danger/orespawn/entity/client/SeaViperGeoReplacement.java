...
public final class SeaViperGeoReplacement extends OreSpawnGeoReplacement<SeaViper> {
    ...
    /** The SPEC's {@code locomotion: swimmer} (tools/artist_specs/sea_viper.json): {@code inWater} is {@code isInWater()} (contract section 3; the weights slice: every landed species carries its seed's word, the asset audit pins it). */
    @Override
