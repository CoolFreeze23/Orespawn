...
/**
 * GeckoLib Pointysaurus (the hooks, owner 2026-09-14, addendum item 10): {@link ModelPointysaurus#poseFrom} verbatim on
 * the converted rig, ON THE HOOK (no keyframe layer, no transcription - the self-gate stays closed until an artist
 * delivers {@code idle} and {@code walk}; the landing slice adds the geo, the wiring and the proofs). Wingspeed 1.0f
