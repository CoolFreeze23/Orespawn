...
/**
 * BUG-041 stage 2 (2026-09-13): the 1.7.10 export sets {@code mirror = true} AFTER {@code addBox} (orig ModelSpyro.java:
...
public class SpyroModel extends EntityModel<EntitySpyro> {
    ...
    /** The classic pose over what the model reads from its entity (orig ModelSpyro.java:285 {@code getActivity()}, :328 {@code func_70906_o()}). */
    public void poseFrom(SpyroPose entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
