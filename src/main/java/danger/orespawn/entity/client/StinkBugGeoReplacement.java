 ...
 * untouched; no threshold); the two antennae about Z on 0.4 x ws at 0.2 x PI, mirrored; the jaw about X on 0.2 x ws at
 * 0.04 x PI about 0.18 rad; the two horns about X (0.4 / 0.46 x ws) and Y (0.43 / 0.49 x ws) at 0.15 x PI about 0.52
 * and -+0.3 rad; and the tail's twenty-three parts about X on one 0.1 x ws sine at 0.1 x PI about -0.2 rad.
 *
