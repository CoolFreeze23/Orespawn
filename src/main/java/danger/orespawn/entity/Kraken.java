...
public class Kraken extends Monster {
    ...
    // OPT-006 (applied 2026-08-11): obstruction probe cadence; see
    ...
    private void handleCaughtEntity() {
        ...
        // removes it. ENT-S-100 KT-D, decided faithful (the port had released
        // at isAlive() == false).
    ...
    /**
     * OPT-006 (applied 2026-08-11): the 19x5 = 95-block obstruction probe now
     * runs once every {@value #OBSTRUCTION_PROBE_INTERVAL_TICKS} server
     ...
     * finding's own math, accepted by the decision.
