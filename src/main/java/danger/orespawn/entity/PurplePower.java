...
public class PurplePower extends Mob implements PurplePowerPose {
    ...
    private LivingEntity findSomethingToAttack() {
        if (OreSpawnConfig.PLAY_NICELY.get()) return null; // orig PurplePower.java:268-270 — PlayNicely != 0 returns null ahead of the scan (ENT-S-115)
    ...
    /**
     * orig PurplePower.java:76-78 ({@code func_70692_ba}, canDespawn): {@code return false;} — never despawns, where the 1.21 Mob default (and EntityLiving's) would. ENT-S-171.
     */
    @Override
