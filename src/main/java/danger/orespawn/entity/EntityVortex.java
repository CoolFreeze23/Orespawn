...
public class EntityVortex extends Monster {
    ...
    // OPT-004 (applied 2026-08-11): one cached pull target, rescanned every 5
    // ticks, shared between tick() and customServerAiStep() — replaces the
    ...
    /**
     * OPT-004 (applied 2026-08-11): the target scan runs at most once every
     ...
     * pull/aggro/particle-onset latency the decision accepts. The
     * client-side instance keeps its own independent cache for the particle check.
     */
    @Nullable
