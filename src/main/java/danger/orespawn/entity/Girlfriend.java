...
public class Girlfriend extends TamableAnimal implements RangedAttackMob, danger.orespawn.entity.pose.HumanoidPose {
    ...
    protected void registerGoals() {
        ...
        // two Jealousy tasks (the pair came with commit 6d43caf, 2026-04-06, no stated intent; gated on 2026-09-04
        // decision). Live here: the held-weapon melee in
        ...
        // owner being hit for the hunt's duration, a regression of MOD-033's recorded behaviour (the wave-4). At
        ...
        // commit 74bc745, pre-empted by Jealousy @4 and tied with @5) in both modes; the modern-only owner pair sits @1 / @2
     ...
     * {@code canAttack}, ENT-S-135); the Boyfriend task keeps both, as a
     * Boyfriend reached :108 / :117 in orig.
     */
