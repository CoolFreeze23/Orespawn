...
public class Robot5 extends Monster {
    ...
    protected void registerGoals() {
        ...
        // orig Robot5.java:56 — EntityAIHurtByTarget(this, false): the revenge task the pass's 1-in-50 (:214-216) ended by nulling the
    ...
    /** orig Robot5.java:56 {@code EntityAIHurtByTarget(this, false)} — the revenge task the pass's 1-in-50 (:214-216) ended by nulling the attack target. ENT-S-131. */
