...
public class AmbientFlightGoal extends Goal {
     ...
     * cells 0, 1, 2 retarget, 3 hunts; 4.5 at HEAD retargeted at 3 and 4 too — ENT-S-135); the other presets stand as at HEAD. {@code blendY} is
     * the y axis's own steering blend: the Dragonfly's 0.20000000149011612 against its x / z 0.3 (orig Dragonfly.java:155-157 blended y by a
     * smaller factor — ENT-S-149); every other flyer blended all three axes by one factor, so the eleven-argument constructor sets {@code blendY
     * = blend} and those presets read as before.
     */
