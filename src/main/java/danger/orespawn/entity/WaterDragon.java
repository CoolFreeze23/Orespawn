...
public class WaterDragon extends TamableAnimal {
    ...
    public boolean hurt(DamageSource source, float amount) {
        ...
        // living attacker only when super.hurt processed it, which is what lastHurtByMob records —
        // ENT-S-117).
     ...
     * only through the PlayNicely / baby returns — and leaves any foreign occupant alone:
     * a dead one was dropped at :698, and under the PlayNicely / baby gates (:683-688) orig consulted
     * nothing. ENT-S-117.
     */
    private void selectTarget() {
        ...
        if (pick != slot) {                                                         // a fresh pick: the slot was cleared at :698 (or held a superseded pick)
            ...
            // substituted or cancelled the set (the ENT-S-108 hardening).
