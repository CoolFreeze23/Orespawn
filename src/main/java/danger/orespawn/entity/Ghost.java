...
public class Ghost extends AmbientCreature {
    ...
    protected void customServerAiStep() {
        ...
        // design promotes them to weak hostile mobs, so damage is tied
        // to physical proximity rather than a MeleeAttackGoal to
        // preserve the drift-only movement profile. We prefer
        // goalSelector's target but fall back to nearest-player
        // detection so the damage still triggers even though
        // AmbientCreature doesn't fully exercise the aggro pipeline.
    ...
    public boolean checkSpawnRules(net.minecraft.world.level.LevelAccessor level,
        ...
        // orig OreSpawnMain.java:4518-4521,4544-4565 — the 22-biome w15 3-6 block
        // was only registered on Oct 31; the year-round block (:4783-4788) covers
