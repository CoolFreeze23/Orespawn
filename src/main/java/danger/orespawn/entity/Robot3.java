 ...
 */
public class Robot3 extends Monster implements Robot3Pose {
    ...
    protected void registerGoals() {
        ...
        // orig Robot3.java:58 — EntityAIHurtByTarget(this, false): the revenge task the pass's 1-in-50 (:242-244) ended by nulling the
    ...
    /** orig Robot3.java:58 {@code EntityAIHurtByTarget(this, false)} — the revenge task the pass's 1-in-50 (:242-244) ended by nulling the attack target. ENT-S-131. */
    ...
    private LivingEntity findSomethingToAttack() {
        if (OreSpawnConfig.PLAY_NICELY.get()) return null; // orig Robot3.java:322-324 — PlayNicely != 0 returns null ahead of the scan (ENT-S-115)
    ...
    private boolean isSuitableTarget(LivingEntity target) {
        ...
        if (!this.getSensing().hasLineOfSight(target)) return false; // orig Robot3.java:306-308 — canSee, after the ignore screen and ahead of the EntityMob refusal (:309) (ENT-S-118)
