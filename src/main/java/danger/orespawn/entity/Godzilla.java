...
public class Godzilla extends Monster implements OreSpawnPartEntity.MultipartBoss {
     ...
     * quarter) when PlayNicely was set at construction time. ENT-S-095 the
     * 2026-09-03 decision: the port's 10x25 (registered and returned here
     * against ModEntities' own 9.9 comment) is restored to 9.9x25; the
     * ModEntities registration carries the same value.
     */
    @Override
