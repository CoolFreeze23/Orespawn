...
public class ThePrince extends TamableAnimal implements ThePrincePose {
    ...
    protected void registerGoals() {
        ...
        // applies to newly spawned Princes); orig ThePrince.java:86-92 registered no target tasks at all.
    ...
    private LivingEntity findSomethingToAttack() {
        ...
        // orig ThePrince.java:776 — the loop takes the first candidate that passes isSuitableTarget AND the feet ray canSeeTarget(posX, posY, posZ) (ENT-S-118)
    ...
    /**
     * orig ThePrince.java:416-418 ({@code canSeeTarget}): {@code worldObj.rayTraceBlocks(Vec3(posX, posY + 0.75, posZ),
     * Vec3(pX, pY, pZ), false) == null} — a block-only ray from 0.75 above the feet to a point; the scan (:776) aims it
