 ...
 * lanes, 2026-09-14; the Slice 4b form of {@link HerculesBeetlePose}): the attacking flag that switches the rig
 * between its folded bush (the body and both arms lowered, every rotation 0) and its walking, arm-waving monster
 * (orig ModelLeafMonster.java {@code getAttacking() == 0}; the port's LeafMonsterModel.poseFrom). The classic model and
