...
/**
 * What {@code ModelDragon.poseFrom} reads from its entity, as an interface the entity already satisfies (the hooks, owner
 * 2026-09-14, addendum item 10; the {@link OstrichPose} shape) - the Dragon and, through it, the Baby Dragon, one rig for
 * two registries: the per-entity render scratch whose {@code rf1} is the ridden-flight neck-yaw latch (orig
 * ModelDragon.java:417, :538-551), the activity and attacking flags that pick the leg, wing, tail and mouth rhythms (orig
 * :425, :457, :492, :496, :538, :575), the sitting flag that stills the tail (orig :500 {@code func_70906_o()}, the port's
 * {@code isInSittingPose()}), and the movement delta the walk amplitude is built from (orig :419 {@code field_70169_q -
