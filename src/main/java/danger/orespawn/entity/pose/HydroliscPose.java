 ...
 * survey, 2026-09-14; the Slice 4b form of {@link HerculesBeetlePose}): the sitting check that stills the
 * tail's three-ring sway (orig ModelHydrolisc.java {@code isSitting()}; the port's HydroliscModel.poseFrom) and the
 * health pair whose fraction {@code hf = health / maxHealth} scales both the frequency and the amplitude of
 * the three head feathers (the HEALTH-FREQUENCY idiom). The classic model and the GeckoLib hook both pose from
