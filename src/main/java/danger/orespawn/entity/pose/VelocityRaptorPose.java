 ...
 * hooks, the Slice 4b form of {@link Robot2Pose}): the health fraction {@code getHealth() /
 * getMaxHealth()} that scales both the rate and the amplitude of the head-feather sway and the tail-feather beat
 * (the HEALTH-FREQUENCY idiom; orig ModelVelocityRaptor.java:274 {@code hf = c.func_110143_aJ() /
