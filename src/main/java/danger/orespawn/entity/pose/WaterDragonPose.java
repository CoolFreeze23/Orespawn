 ...
 * hooks, owner 2026-09-14, addendum item 10; the Slice 4b form of {@link Robot2Pose}): the sitting check that stills
 * the body fin, the neck fin and the head fin (orig ModelWaterDragon.java:222, :227, :232 {@code e.func_70906_o()};
 * the port's {@code isInSittingPose()}), and the three-way attacking value that picks the jaw's pitch - 1: the 1.2 x
 * wingspeed cosine at 0.25 x PI, 2: 0.45 rad, otherwise -0.25 rad (orig :236 {@code e.getAttacking() == 1 ... == 2}).
