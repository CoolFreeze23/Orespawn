 ...
 * remainder slice, 2026-09-15, owner's closing set item 3 with the bipeds; the Slice 4b form of {@link ThePrincePose},
 * whose pose hers is - the activity (2 = flying tucks the legs), the attacking flag (the wings' and tail's fast rhythms,
 * the three jaws' chatter), the sit order that stills the tail ({@code TamableAnimal.isOrderedToSit()}) and the three
 * heads' neck extensions in degrees (the port's {@code ModelThePrincess.poseFrom}; orig ModelThePrincess.java
