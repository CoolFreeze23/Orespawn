 ...
 * owner 2026-09-14, addendum item 10; the {@link OstrichPose} shape): the per-entity render scratch whose {@code rf1} is
 * the ridden-flight neck-yaw latch (orig ModelCephadrome.java:383, :469-482), the activity and attacking flags that pick the
 * leg, wing, tail and mouth rhythms (orig :397, :417, :437, :469, :503), and the movement delta the walk amplitude is
 * built from (orig :385 {@code field_70169_q - field_70165_t}, {@code field_70166_s - field_70161_v}; :470
 * {@code field_70126_B - field_70177_z}). The classic model and the GeckoLib hook both pose from this, so the parity
 * harness can drive them headlessly with a declared state instead of a live entity. Everything but {@link #getRenderInfo},
 * {@link #getAttacking}, {@link #getActivity}, {@link #xOld}, {@link #zOld} and {@link #yRotO} is {@code Entity}'s own.
 */
