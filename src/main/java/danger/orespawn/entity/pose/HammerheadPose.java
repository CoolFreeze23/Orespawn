 ...
 * the Slice 4b form of {@link HerculesBeetlePose}): the attacking flag that nods the sixteen neck / head / horn / fan /
 * ear parts on a {@code 1.3 x wingspeed} cosine x PI x 0.13 over their rest pitches (the port's {@code
 * ModelHammerhead.poseFrom} {@code entity.getAttacking() != 0}; orig ModelHammerhead.java
