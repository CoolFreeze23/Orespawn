 ...
 * owner 2026-09-14, addendum item 10; the Slice 4b form of {@link HerculesBeetlePose}): the screaming flag that raises the
 * arms and the blade into the fast 2.7 ws swing (orig ModelEnderKnight.java:332 {@code if (e.isScreaming())}; the port's
