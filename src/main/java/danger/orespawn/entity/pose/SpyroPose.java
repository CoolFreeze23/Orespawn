 ...
 * owner 2026-09-14, addendum item 10; the Slice 4b form of {@link Robot2Pose}): the activity that halves the wing beat
 * and stills the legs and tail while flying (3), and folds the legs under the body while sitting-flat (2) (orig
 * ModelSpyro.java:285 {@code c.getActivity()}; the port's SpyroModel.poseFrom), and the sitting check that stills the
 * tail (orig :328 {@code c.func_70906_o() || current_activity == 3}; the port's {@code isInSittingPose()}). The classic
