 ...
 * center spin and the eight spine rhythms between their slow rest rates (0.02 / 0.07 ... x wingspeed, amplitude 0.02 x
 * PI) and their fast attack rates (0.2 / 0.7 ..., amplitude 0.06 x PI) (orig ModelUrchin.java:175
 * {@code u.getAttacking() != 0}; the port's ModelUrchin.poseFrom). The classic model and the GeckoLib hook both pose
