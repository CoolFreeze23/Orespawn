 ...
 * hooks, the Slice 4b form of {@link HerculesBeetlePose}): the attacking flag that lashes the tail on a 1.3 x
 * wingspeed cosine x PI x 0.25 in place of its 0.3 x PI x 0.05 idle sway (the port's {@code
 * ModelPointysaurus.poseFrom} {@code entity.getAttacking() != 0}; orig ModelPointysaurus.java setRotationAngles). The
