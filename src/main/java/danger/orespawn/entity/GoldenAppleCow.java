 ...
 * (verified Phase 14). Implementation mirrors {@link AppleCow} with
 * {@link Items#GOLDEN_APPLE} and a tighter 1–2 drop window so a single
 * kill is meaningful but doesn't trivialise the natural-cave golden
 * apple economy.
 *
