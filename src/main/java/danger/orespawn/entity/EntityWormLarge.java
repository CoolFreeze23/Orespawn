...
public class EntityWormLarge extends Monster {
    ...
    // OPT-007 (applied 2026-08-11, neutral half only): per-tick shared
    ...
    /**
     * OPT-007 (applied 2026-08-11, NEUTRAL HALF ONLY): aiStep and
    ...
    /**
     * orig WormLarge.java:64-66 ({@code func_70692_ba}, canDespawn): {@code return false;} — never despawns, where EntityMob (and 1.21 Monster) would. ENT-S-171.
     */
    @Override
