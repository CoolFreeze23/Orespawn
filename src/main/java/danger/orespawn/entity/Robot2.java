...
public class Robot2 extends Monster implements Robot2Pose {
    ...
    protected void customServerAiStep() {
        ...
        if (this.getRandom().nextInt(6) == 1 && !OreSpawnConfig.PLAY_NICELY.get()) {
            ...
            if (this.getRandom().nextInt(50) == 1) { this.setTarget(null); this.revengeGoal.release(); } // orig :281-283 — the task ended on the nulled target; vanilla's TargetGoal would re-assert its memory (ENT-S-129)
