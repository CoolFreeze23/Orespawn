 ...
 * FEEL is an in-game look per the recorded exit evidence) plus the
 * ratified part-stream gate predicate and the S3b→S5 seat resolution.
 */
...
public class RideTests {
    ...
    /**
     * Spawns a spider under {@code mode}. Master-override decision of
     * 2026-09-04: the spiderMovement key is inert while {@code [modern]
     * enabled} is off, so the master is raised for MODERN (and lowered for
     * CLASSIC) alongside the key; both are restored together once the
     * construction snapshot is taken.
     */
    ...
    /**
     * S5 seat resolution (the S3b notes): while ridden the visual body is
    ...
    public void s7_seat_geometry(GameTestHelper helper) {
        ...
        final Mob[] riders = new Mob[4];
        {
            ...
            try {
                ...
                // override); both restored together.
