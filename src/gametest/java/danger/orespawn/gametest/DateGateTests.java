...
public class DateGateTests {
     ...
     * half of the D4 fix —; port Girlfriend.java:86-121
     * applyValentineState / getDefaultDimensions, restoring orig
     * Girlfriend.java:142-144,198-200, 569-574). A Girlfriend created on
     * Feb 14 is the giant angry variant (800 max HP, 2.5x8.0); on any
     * other date she is the normal 80 HP 0.5x1.6 companion.
     * Rendering-side criteria (girlfriendv texture, 5x render scale) stay
     * manual — item i178.
     */
     ...
     * OreSpawnMain.java:4570-4571,4681). Biome registration data half: the
     * three shipped companion_easter_bunny__* biome
     * modifiers all spawn {@code orespawn:easter_bunny}.
     * Egg-laying itself is date-independent and covered by A4 — out of
     * scope here.
     */
