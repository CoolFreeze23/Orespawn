...
/**
 * S6a — sitting finding F-1 (deliberate delta): part entities
 * forward interactions to the parent, so legs are clickable mount
 * surfaces. Player-path law: the tests drive the same
