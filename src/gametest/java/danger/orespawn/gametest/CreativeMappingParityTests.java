 ...
 * strafe — fixed under the same decision and pinned here by a {@link GameTestGenerator}
 * over {@link #filterSites()} plus {@link #assertBrutalflyStrafe}.
 *
...
public class CreativeMappingParityTests {
    ...
    /**
     * ENT-S-109: the three cases of the decision per site — 27 over the nine filter sites
     * plus three for the Brutalfly's strafe — 30 TestFunctions in the {@code
     * creativeMappingParity} batch, named {@code creativemappingparitytests.s109_<site>_<case>}.
     */
    @GameTestGenerator
