 ...
 * {@code feetisSuitableTarget}); the port had kept it in eleven. It was
 * decided every site restored in its original position in the check order,
 * with one generated test per original call site — this
 * class, a {@link GameTestGenerator} over the 38-row table in {@link
 * #sites()}, in orig file order, each row citing its orig line.
 *
