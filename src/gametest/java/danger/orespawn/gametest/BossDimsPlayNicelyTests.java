...
/**
 * ENT-S-095 batch 2: the PlayNicely-branched boss hitbox, pinned in BOTH
 * modes as a constructor snapshot. Godzilla sizes itself in the
 * constructor exactly like the Kraken and the King: orig
 ...
 * 10x25 against its own 9.9 comment (ModEntities / Godzilla.java); the
 * decision restores 9.9x25, and the quarter-size nice box 2.475x6.25 already matched.
 *
    ...
    public void s095_godzilla_hitbox_full_9_9x25_when_play_nicely_off(GameTestHelper helper) {
        ...
        try {
            ...
            assertDims(helper, godzilla, GODZILLA_FULL_WIDTH, GODZILLA_FULL_HEIGHT,
                    "Godzilla constructed with playNicely=false must be 9.9x25 (orig Godzilla.java:72 func_70105_a(9.9f, 25.0f); a 2026-09-03 decision restored the port's 10x25)");
        } finally {
