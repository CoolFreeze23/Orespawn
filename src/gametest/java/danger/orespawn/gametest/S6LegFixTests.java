...
/**
 * S6b — THE LEG FIX (exit criterion: "legs never cross the body
 * midline, never stretch beyond the classic stance, and stepping reads as
 * insect movement — legs on each side staying on their side, planting
 * and lifting in a natural rhythm"). The suite-provable halves: the SIDE
 * INVARIANT (a grounded foot's body-local lateral sign always matches
 * its leg's side — guaranteed by comfort radius &lt; min lateral rest
 * offset), the COMFORT INVARIANT (no grounded foot ever outside the
...
public class S6LegFixTests {
    ...
    public void s6b_spider_spin_flick_no_crossing(GameTestHelper helper) {
        ...
        try {
            // Master-override decision of 2026-09-04: MODERN needs the master on.
