 ...
 * <li>{@code kf_007} (the first Tier-2 slice): the presented state - every one of the twenty-one shipped
 * replacements, constructed registry-free on this server, declares no keyframe layer but the Beaver (its three)
 * and the seven Tier-2 descriptors (their transcriptions, pinned group by group in {@link T2SeamTests}); {@code
