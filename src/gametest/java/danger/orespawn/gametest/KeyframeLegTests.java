 ...
 * <li>{@code kf_007} (the Tier-2 slices): the presented state - every one of the twenty-eight shipped
 * replacements, constructed registry-free on this server, declares no keyframe layer but the Beaver (its three) and
 * the fourteen Tier-2 descriptors (their transcriptions, pinned group by group in {@link T2SeamTests}); {@code
