...
public class PurplePowerPoseTests {
    ...
    /**
     * ENT-S-146: the GeckoLib descriptor's {@code renderColor} / {@code fullBright} / {@code
     * cubeFaceOrderRequired} on a live PurplePower, against the classic model's constants. {@code
     * renderType(entity)} is deliberately NOT called: it returns the classic model's {@code
     * Function<ResourceLocation, RenderType>} - a client type held by a client-only class
