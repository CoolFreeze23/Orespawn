 ...
 * while BOTH {@code [modern].enabled} (master, default true; it was
 * introduced with default false the day before) and {@code
 * [modern].mothraWideRootHitbox} (sub-key, default true) are on, and
