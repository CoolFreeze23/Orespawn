...
/**
 * The XS parity batch (ENT-S-148 / 149 / 151 — parity, classic): three flight-target transcriptions pinned at the orig positions.
 * One generated {@link TestFunction} per row ({@code
 * flighttargetparitytests.s<finding>_NN_<species>_<what>}), all in the {@code flightTargetParity} batch (TEST-003).
 *
