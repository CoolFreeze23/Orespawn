...
public class StinkyIdleParityTests {
    ...
    private static List<Site> sites() {
        ...
        sites.add(new Site(19, "stinky_599_eat_radius_from_scan_origin", FINDING, "Stinky.java:599 (closest < 12, from the scan origin)", "EntityStinky.eatCoalOre (the eat radius base)",
                "the coal ore at origin + (3, 1, 1), distSq 11 from the scan origin (shell 3's +x face at dy = 2) — eaten, healed and burped; from the Stinky's own block it is 14, so a radius measured from the entity block (HEAD's base) would leave it standing",
