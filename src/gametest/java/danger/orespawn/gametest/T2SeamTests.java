...
public class T2SeamTests {
     ...
     * item 2; TEST-013; the seam's {@code OreSpawnGeoReplacedEntityRenderer.applyRotations} path, whose one line is
     * {@code descriptor.renderTransform().applySlot(poseStack)} after the entity yaw and the descriptor's own rotations).
     * The classic path rotates INSIDE {@code renderToBuffer}, after {@code LivingEntityRenderer.render}'s
