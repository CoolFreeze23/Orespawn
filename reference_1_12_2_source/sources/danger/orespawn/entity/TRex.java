...
extends EntityMob {
    ...
    private EntityLivingBase findSomethingToAttack() {
        ...
        List var5 = this.field_70170_p.func_72872_a(EntityLivingBase.class, this.func_174813_aQ().func_72321_a(20.0, 6.0, 20.0));
    ...
    public int getAttacking() {
        return Byte.valueOf((Byte)this.field_70180_af.func_187225_a(ATTACKING)).byteValue();
    }
    ...
    public boolean func_70601_bi() {
        ...
        TRex target = null;
        target = (TRex)this.field_70170_p.func_72857_a(TRex.class, this.func_174813_aQ().func_72321_a(24.0, 12.0, 24.0), (Entity)this);
        return target == null;
    }
}
