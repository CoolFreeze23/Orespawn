...
extends EntityMob {
    ...
    protected void func_70619_bc() {
        ...
        if (this.stuck_count > 30 || this.field_70170_p.field_73012_v.nextInt(200) == 0 || this.currentFlightTarget.func_177954_c((double)((int)this.field_70165_t), (double)((int)this.field_70163_u), (double)((int)this.field_70161_v)) < 9.0) {
            Block bid;
            int down = 0;
            int dist = 20;
            for (int i = -5; i <= 5; i += 5) {
            ...
            while (bid != Blocks.field_150350_a && keep_trying != 0) {
                ...
                this.currentFlightTarget = new BlockPos((int)this.field_70165_t + (newx *= xdir), (int)this.field_70163_u + this.field_70170_p.field_73012_v.nextInt(7) - 1 - down, (int)this.field_70161_v + (newz *= zdir));
        ...
        if (this.field_70170_p.field_73012_v.nextInt(6) == 0) {
            ...
            target = (EntityPlayer)this.field_70170_p.func_72857_a(EntityPlayer.class, this.func_174813_aQ().func_72321_a(30.0, 20.0, 30.0), (Entity)this);
            if (target != null) {
    ...
    public boolean func_70601_bi() {
        ...
        target = (Brutalfly)this.field_70170_p.func_72857_a(Brutalfly.class, this.func_174813_aQ().func_72321_a(64.0, 32.0, 64.0), (Entity)this);
        return target == null;
    }
    ...
    private EntityLivingBase findSomethingToAttack() {
        List var5 = this.field_70170_p.func_72872_a(EntityLivingBase.class, this.func_174813_aQ().func_72321_a(25.0, 20.0, 25.0));
