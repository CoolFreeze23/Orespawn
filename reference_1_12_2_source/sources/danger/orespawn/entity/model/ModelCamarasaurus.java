...
extends ModelBase {
    ...
    public void func_78088_a(Entity entity, float f, float f1, float f2, float f3, float f4, float f5) {
        ...
        newangle = (double)f1 > 0.1 ? MathHelper.func_76134_b((float)(f2 * 0.4f * this.wingspeed)) * (float)Math.PI * 0.25f * f1 : 0.0f;
        ...
        newangle = MathHelper.func_76134_b((float)(f2 * 0.8f * this.wingspeed * hf)) * (float)Math.PI * 0.25f * hf;
        if (c.func_70906_o()) {
            newangle = 0.0f;
        }
        ...
        if (this.field_78091_s) {
            ...
            GL11.glPushMatrix();
            GL11.glTranslatef((float)0.0f, (float)0.45000005f, (float)0.0f);
