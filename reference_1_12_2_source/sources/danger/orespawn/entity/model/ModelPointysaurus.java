...
extends ModelBase {
    ...
    public void func_78088_a(Entity entity, float f, float f1, float f2, float f3, float f4, float f5) {
        ...
        newangle = e.getAttacking() != 0 ? MathHelper.func_76134_b((float)(f2 * 0.4f * this.wingspeed)) * (float)Math.PI * 0.25f : MathHelper.func_76134_b((float)(f2 * 0.3f * this.wingspeed)) * (float)Math.PI * 0.05f;
