...
extends BlockCrops {
    ...
    public void func_180650_b(World worldIn, BlockPos pos, IBlockState state, Random rand) {
        ...
        ArrayList mothList = new ArrayList();
        chunk.func_177430_a(Moth.class, aabb, mothList, e -> true);
        if (mothList.size() > 15) {
            return;
        }
        ...
        if (worldIn.func_180495_p(pos.func_177981_b(1)).func_177230_c() == Blocks.field_150350_a && !worldIn.func_72935_r()) {
            Entity moth = EntityList.func_191304_a(Moth.class, (World)worldIn);
            assert (moth != null);
            moth.func_70107_b((double)pos.func_177958_n(), (double)(pos.func_177956_o() + 1), (double)pos.func_177952_p());
            worldIn.func_72838_d(moth);
        }
    }
