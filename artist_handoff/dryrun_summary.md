...
| entity | tier | files | bones | cubes | clips shipped | clips in SPEC | goals | flags | attacking | strike/launch sites | textures | locked | unlabelled | round-trip | effort | warnings |
|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|
| the_queen | Tier 1 (boss; the design's 'done' row) | 9 | 110 | 130 | 8 | 8 | 5 | 6 | STATE | 6 | 2 | 27 (26 keyed by the shipped clips; warn) | 0 | EQUAL, order kept | 27.5 h | 1 |
| beaver | Tier 2 | 9 | 9 | 9 | 4 | 11 | 8 | 0 | NONE | 0 | 1 | 0 | 0 | EQUAL, order kept | 12.8 h | 0 |
