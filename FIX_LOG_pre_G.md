# FIX_LOG — Phases A–F (2026-06-11 to 2026-08-21), moved unchanged from FIX_LOG.md

Moved UNCHANGED from `FIX_LOG.md` lines 128–3452 (the file at commit 182a76d) on 2026-09-12 under the owner's ruling
of 2026-09-12, item 8: the live `FIX_LOG.md` keeps its preamble (with "Pending manual tests") and every Phase G
section, and lanes read only the live file from then on. The sections below begin at line 9 of this file;
a pre-2026-09-12 citation `FIX_LOG.md:N` with 128 <= N <= 3452 is line N − 119 here, and one with N > 3452 is
line N − 3323 of the live `FIX_LOG.md`. sha256 of the moved block: 1ad79a16dc77c569.
