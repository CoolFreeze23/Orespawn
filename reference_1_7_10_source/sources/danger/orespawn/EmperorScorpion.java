        ...
        if (this.field_70170_p.field_73012_v.nextInt(4) == 0) {
            ...
            if (e != null) {
                ...
                if (this.field_70170_p.field_73012_v.nextInt(20) == 1) {
                    EntityCreature entityCreature = (EntityCreature)EmperorScorpion.spawnCreature((World)this.field_70170_p, (String)"Scorpion", (double)((this.field_70165_t + e.field_70165_t) / 2.0 + (double)this.field_70170_p.field_73012_v.nextInt(5) - (double)this.field_70170_p.field_73012_v.nextInt(5)), (double)((this.field_70163_u + e.field_70163_u) / 2.0 + 1.01), (double)((this.field_70161_v + e.field_70161_v) / 2.0 + (double)this.field_70170_p.field_73012_v.nextInt(5) - (double)this.field_70170_p.field_73012_v.nextInt(5)));
                }
            } else {
                this.setAttacking(0);
            }
