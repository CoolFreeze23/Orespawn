...
extends Item {
    ...
    public void makeTree(World world, int x, int y, int z, Block blkid, Chunk chunk) {
        ...
        for (j = 1; j < w1; ++j) {
            OreSpawnMain.setBlockSuperFast((World)world, (int)(x + j), (int)(y + h2), (int)z, (Block)Blocks.field_150364_r, (int)0, (int)2, (Chunk)chunk);
        }
        for (j = 1; j < w1; ++j) {
            OreSpawnMain.setBlockSuperFast((World)world, (int)(x - j), (int)(y + h2), (int)z, (Block)Blocks.field_150364_r, (int)0, (int)2, (Chunk)chunk);
        }
        for (j = 1; j < w1; ++j) {
            OreSpawnMain.setBlockSuperFast((World)world, (int)x, (int)(y + h2), (int)(z + j), (Block)Blocks.field_150364_r, (int)0, (int)2, (Chunk)chunk);
        }
        for (j = 1; j < w1; ++j) {
            OreSpawnMain.setBlockSuperFast((World)world, (int)x, (int)(y + h2), (int)(z - j), (Block)Blocks.field_150364_r, (int)0, (int)2, (Chunk)chunk);
        }
        for (j = 1; j < w2; ++j) {
            OreSpawnMain.setBlockSuperFast((World)world, (int)(x + j), (int)(y + h3), (int)z, (Block)Blocks.field_150364_r, (int)0, (int)2, (Chunk)chunk);
        }
        for (j = 1; j < w2; ++j) {
            OreSpawnMain.setBlockSuperFast((World)world, (int)(x - j), (int)(y + h3), (int)z, (Block)Blocks.field_150364_r, (int)0, (int)2, (Chunk)chunk);
        }
        for (j = 1; j < w2; ++j) {
            OreSpawnMain.setBlockSuperFast((World)world, (int)x, (int)(y + h3), (int)(z + j), (Block)Blocks.field_150364_r, (int)0, (int)2, (Chunk)chunk);
        }
        for (j = 1; j < w2; ++j) {
            OreSpawnMain.setBlockSuperFast((World)world, (int)x, (int)(y + h3), (int)(z - j), (Block)Blocks.field_150364_r, (int)0, (int)2, (Chunk)chunk);
        }
