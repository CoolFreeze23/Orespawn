...
extends EntityMob {
    ...
    protected void func_70619_bc() {
        ...
        if (OreSpawnMain.PlayNicely == 0 && k == 0) {
            this.doJumpDamage(dx, this.field_70163_u, dz, 15.0, (double)(OreSpawnMain.Godzilla_stats.attack / 2), 1);
        }
        if (this.field_70170_p.field_73012_v.nextInt(5 - this.large_unknown_detected) == 1) {
            ...
            if (e == null) {
                ...
                if (this.head_found == 0) {
                    EntityLiving newent = (EntityLiving)Godzilla.spawnCreature((World)this.field_70170_p, (String)"MobzillaHead", (double)this.field_70165_t, (double)(this.field_70163_u + 20.0), (double)this.field_70161_v);
                }
            }
            if (e != null) {
