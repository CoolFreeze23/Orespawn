                ...
                if (this.closest < 6) {
                    if (this.field_70170_p.field_73012_v.nextInt(3) != 0) {
                        ...
                        if (this.findBuddies() < 10) {
                            Termite.spawnCreature((World)this.field_70170_p, (String)"Termite", (double)(this.field_70165_t + (double)0.1f), (double)(this.field_70163_u + (double)0.1f), (double)(this.field_70161_v + (double)0.1f));
                        }
                    } else {
                        if (this.field_70170_p.func_82736_K().func_82766_b("mobGriefing")) {
                        ...
                        if (this.findBuddies() < 10) {
                            Termite.spawnCreature((World)this.field_70170_p, (String)"Termite", (double)((float)this.tx + 0.1f), (double)((float)this.ty + 0.1f), (double)((float)this.tz + 0.1f));
                        }
                    }
