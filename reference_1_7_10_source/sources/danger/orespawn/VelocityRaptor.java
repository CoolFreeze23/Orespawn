...
extends EntityCannonFodder {
    ...
    public VelocityRaptor(World par1World) {
        ...
        this.field_70714_bg.func_75776_a(2, (EntityAIBase)new MyEntityAIFollowOwner((EntityTameable)this, 1.5f, 10.0f, 2.0f));
        this.field_70714_bg.func_75776_a(3, (EntityAIBase)new MyEntityAIAvoidEntity((EntityCreature)this, EntityMob.class, 8.0f, 1.0, (double)1.4f));
