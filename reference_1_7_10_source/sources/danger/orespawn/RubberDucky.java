...
extends EntityTameable {
    ...
    public RubberDucky(World par1World) {
        ...
        this.field_70714_bg.func_75776_a(1, (EntityAIBase)new MyEntityAIFollowOwner((EntityTameable)this, 2.0f, 10.0f, 2.0f));
            ...
            if (this.killcount < 10) {
                for (int m = 0; m < 20; ++m) {
                    ...
                    for (int j = 3; j > -3; --j) {
                        ...
                        Entity e = RubberDucky.spawnCreature((World)this.field_70170_p, (String)"Rubber Ducky", (double)((int)this.field_70165_t + i + 1), (double)((int)this.field_70163_u + j + 1), (double)((int)this.field_70161_v + k));
                        if (e != null) {
