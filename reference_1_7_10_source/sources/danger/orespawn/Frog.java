...
extends EntityAnimal {
        ...
        block2: {
            ...
            block3: {
                block4: {
                    ...
                    Boyfriend ent = null;
                    ent = (Boyfriend)Frog.spawnCreature((World)world, (String)"Boyfriend", (double)this.field_70165_t, (double)(this.field_70163_u + 0.01), (double)this.field_70161_v);
                    if (ent != null) {
                ...
                Girlfriend ent = null;
                ent = (Girlfriend)Frog.spawnCreature((World)world, (String)"Girlfriend", (double)this.field_70165_t, (double)(this.field_70163_u + 0.01), (double)this.field_70161_v);
    ...
    public boolean func_70601_bi() {
        ...
        if (this.field_70170_p.field_73011_w.field_76574_g == OreSpawnMain.DimensionID5 && this.field_70170_p.field_73012_v.nextInt(20) != 1) {
            return false;
        }
