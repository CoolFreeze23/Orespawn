...
extends Item {
    ...
    public ItemStack func_77659_a(ItemStack par1ItemStack, World par2World, EntityPlayer par3EntityPlayer) {
        ...
        if (!par2World.field_72995_K) {
            double xzoff = 2.5;
            double yoff = 1.65;
            Entity e = ItemSquidZooka.spawnCreature((World)par2World, (String)"Attack Squid", (double)(par3EntityPlayer.field_70165_t - xzoff * Math.sin(Math.toRadians(par3EntityPlayer.field_70759_as + 15.0f))), (double)(par3EntityPlayer.field_70163_u + yoff), (double)(par3EntityPlayer.field_70161_v + xzoff * Math.cos(Math.toRadians(par3EntityPlayer.field_70759_as + 15.0f))));
