...
public class Trees {
    ...
    private void WindTreeBranch(World world, int x, int y, int z, int length, int dirx, int dirz) {
        for (int i = 1; i <= length; ++i) {
            OreSpawnMain.setBlockFast((World)world, (int)(x + i * dirx), (int)y, (int)(z + i * dirz), (Block)Blocks.field_150364_r, (int)0, (int)2);
            if (Blocks.field_150350_a == world.func_147439_a(x + i * dirx, y + 1, z + i * dirz)) {
                OreSpawnMain.setBlockFast((World)world, (int)(x + i * dirx), (int)(y + 1), (int)(z + i * dirz), (Block)Blocks.field_150362_t, (int)0, (int)2);
            }
            if (i < length / 3 && Blocks.field_150350_a == world.func_147439_a(x + i * dirx, y + 2, z + i * dirz)) {
                OreSpawnMain.setBlockFast((World)world, (int)(x + i * dirx), (int)(y + 2), (int)(z + i * dirz), (Block)Blocks.field_150362_t, (int)0, (int)2);
            }
            if (i <= length / 3) continue;
            if (Blocks.field_150350_a == world.func_147439_a(x + i * dirx + dirz, y, z + i * dirz + dirx)) {
                OreSpawnMain.setBlockFast((World)world, (int)(x + i * dirx + dirz), (int)y, (int)(z + i * dirz + dirx), (Block)Blocks.field_150362_t, (int)0, (int)2);
            }
        ...
        if (Blocks.field_150350_a == world.func_147439_a(x + (length + 1) * dirx, y, z + (length + 1) * dirz)) {
            OreSpawnMain.setBlockFast((World)world, (int)(x + (length + 1) * dirx), (int)y, (int)(z + (length + 1) * dirz), (Block)Blocks.field_150362_t, (int)0, (int)2);
        }
        if (Blocks.field_150350_a == world.func_147439_a(x + (length + 2) * dirx, y, z + (length + 2) * dirz)) {
            OreSpawnMain.setBlockFast((World)world, (int)(x + (length + 2) * dirx), (int)y, (int)(z + (length + 2) * dirz), (Block)Blocks.field_150362_t, (int)0, (int)2);
        }
    }
    ...
    public void WindTree(World world, int x, int y, int z, int dir) {
        ...
        for (int j = 0; j < height; ++j) {
            OreSpawnMain.setBlockFast((World)world, (int)x, (int)(j + y), (int)z, (Block)Blocks.field_150364_r, (int)0, (int)2);
            if (j <= height / 5) continue;
            OreSpawnMain.setBlockFast((World)world, (int)(x + dirx), (int)(j + y), (int)(z + dirz), (Block)Blocks.field_150362_t, (int)0, (int)2);
            if (j <= height / 4 || j % 4 != 0) continue;
            this.WindTreeBranch(world, x, j + y, z, height - j, dirx, dirz);
        }
        OreSpawnMain.setBlockFast((World)world, (int)x, (int)(y + height), (int)z, (Block)Blocks.field_150362_t, (int)0, (int)2);
    }
    ...
    private void SkyTreeBranch(World world, int x, int y, int z, int length, int dirx, int dirz) {
        ...
        if (Blocks.field_150350_a == world.func_147439_a(x + length * dirx, y, z + length * dirz)) {
            OreSpawnMain.setBlockFast((World)world, (int)(x + length * dirx), (int)y, (int)(z + length * dirz), (Block)Blocks.field_150362_t, (int)0, (int)2);
        }
    }
    ...
    public void SkyTree(World world, int x, int y, int z) {
        ...
        OreSpawnMain.setBlockFast((World)world, (int)x, (int)(height + 1), (int)z, (Block)Blocks.field_150362_t, (int)0, (int)2);
    ...
    private void grow_small_branch(World world, int x, int y, int z, int xdir, int zdir, int xxdir, int zzdir) {
        ...
        for (n = 0; n < grow; ++n) {
            OreSpawnMain.setBlockFast((World)world, (int)i, (int)j, (int)k, (Block)Blocks.field_150364_r, (int)0, (int)2);
        ...
        grow = 4 + world.field_73012_v.nextInt(3);
        for (n = 0; n < grow; ++n) {
            OreSpawnMain.setBlockFast((World)world, (int)i2, (int)j, (int)k2, (Block)Blocks.field_150364_r, (int)0, (int)2);
        ...
        grow = 3 + world.field_73012_v.nextInt(3);
        for (n = 0; n < grow; ++n) {
            OreSpawnMain.setBlockFast((World)world, (int)i2, (int)j2, (int)k2, (Block)Blocks.field_150364_r, (int)0, (int)2);
    ...
    public void ExperienceTree(World world, int x, int y, int z) {
        ...
        for (j = 1; j < 6; ++j) {
            for (i = 0; i < 2; ++i) {
                for (k = 0; k < 2; ++k) {
                    OreSpawnMain.setBlockFast((World)world, (int)(x + i), (int)(y + j), (int)(z + k), (Block)Blocks.field_150364_r, (int)0, (int)2);
                }
            }
        }
    ...
    public void SmallTree(World world, int x, int y, int z) {
        ...
        if (bid != Blocks.field_150349_c && bid != Blocks.field_150346_d && bid != Blocks.field_150458_ak) {
            ...
            if (bid != Blocks.field_150349_c && bid != Blocks.field_150346_d && bid != Blocks.field_150458_ak) {
                bid = world.func_147439_a(x, y - 3, z);
                if (bid != Blocks.field_150349_c && bid != Blocks.field_150346_d && bid != Blocks.field_150458_ak) {
                    OreSpawnMain.setBlockFast((World)world, (int)x, (int)y, (int)z, (Block)Blocks.field_150350_a, (int)0, (int)2);
                    return;
                }
                realy = y - 3;
            } else {
    ...
    public void makeScragglyBranch(World world, int x, int y, int z, int len, int biasx, int biasz) {
        for (int k = 0; k < len; ++k) {
            ...
            OreSpawnMain.setBlockFast((World)world, (int)x, (int)y, (int)z, (Block)Blocks.field_150364_r, (int)0, (int)2);
            for (int m = -1; m < 2; ++m) {
                for (int n = -1; n < 2; ++n) {
    ...
    public void ScragglyTreeWithBranches(World world, int x, int y, int z) {
        ...
        for (k = 0; k < i; ++k) {
            ...
            OreSpawnMain.setBlockFast((World)world, (int)x, (int)(y + k), (int)z, (Block)Blocks.field_150364_r, (int)0, (int)2);
        }
        y += i - 1;
        for (k = i; k < j; ++k) {
