...
extends EntityMob {
    ...
    protected void func_70628_a(boolean par1, int par2) {
        ...
        Item it = null;
        Block bl = null;
        TheKing.spawnCreature((World)this.field_70170_p, (String)"The Prince", (double)this.field_70165_t, (double)(this.field_70163_u + 10.0), (double)this.field_70161_v);
    ...
    public boolean func_70652_k(Entity par1Entity) {
        boolean var4;
        float s;
        if (!(par1Entity == null || !(par1Entity instanceof EntityLivingBase) || !((s = par1Entity.field_70131_O * par1Entity.field_70130_N) > 30.0f) || MyUtils.isRoyalty((Entity)par1Entity) || par1Entity instanceof Godzilla || par1Entity instanceof GodzillaHead || par1Entity instanceof PitchBlack || par1Entity instanceof Kraken)) {
    ...
    protected void func_70619_bc() {
        ...
        if (this.tooFarFromHome() || this.field_70170_p.field_73012_v.nextInt(200) == 0 || this.currentFlightTarget.func_71569_e((int)this.field_70165_t, (int)this.field_70163_u, (int)this.field_70161_v) < 9.1f) {
            ...
            if (this.head_found == 0) {
                EntityLiving entityLiving = (EntityLiving)TheKing.spawnCreature((World)this.field_70170_p, (String)"KingHead", (double)this.field_70165_t, (double)(this.field_70163_u + 20.0), (double)this.field_70161_v);
            }
            if (e == null) {
                e = f;
            }
            if (e != null) {
                ...
                if (this.func_70068_e((Entity)e) < 900.0) {
                    if (this.field_70170_p.field_73012_v.nextInt(2) == 1) {
                        this.doJumpDamage(this.field_70165_t, this.field_70163_u, this.field_70161_v, 15.0, (double)(OreSpawnMain.TheKing_stats.attack / 4), 0);
                    }
                ...
                if (this.field_70170_p.field_73012_v.nextInt(3) == 1) {
                    this.doJumpDamage(dx, this.field_70163_u + 10.0, dz, 15.0, (double)(OreSpawnMain.TheKing_stats.attack / 2), 1);
                }
        ...
        if (this.getAttacking() != 0 && this.isEnd == 2) {
            double xzoff = 10.0;
            double yoff = 14.0;
            Entity ppwr = TheKing.spawnCreature((World)this.field_70170_p, (String)"PurplePower", (double)(this.field_70165_t - xzoff * Math.sin(Math.toRadians(this.field_70177_z))), (double)(this.field_70163_u + yoff), (double)(this.field_70161_v + xzoff * Math.cos(Math.toRadians(this.field_70177_z))));
            if (ppwr != null) {
