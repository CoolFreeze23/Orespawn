...
extends EntityCannonFodder {
    ...
    public Chipmunk(World par1World) {
        ...
        this.field_70714_bg.func_75776_a(2, (EntityAIBase)new MyEntityAIFollowOwner((EntityTameable)this, 2.0f, 10.0f, 2.0f));
        this.field_70714_bg.func_75776_a(3, (EntityAIBase)new MyEntityAIAvoidEntity((EntityCreature)this, EntityMob.class, 8.0f, 1.0, (double)1.6f));
    ...
    private int findBuddies() {
        List var5 = this.field_70170_p.func_72872_a(Chipmunk.class, this.field_70121_D.func_72314_b(20.0, 10.0, 20.0));
        return var5.size();
    }
