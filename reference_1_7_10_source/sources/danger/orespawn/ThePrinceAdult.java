    ...
    public void func_70619_bc() {
        ...
        if (this.getActivity() == 0 && this.field_70153_n == null && this.field_70170_p.field_73013_u != EnumDifficulty.PEACEFUL && this.func_70909_n() && OreSpawnMain.FullPowerKingEnable != 0) {
            ...
            if (this.growcounter > 288000) {
                Entity ent = null;
                TheKing d = null;
                ent = ThePrinceAdult.spawnCreature((World)this.field_70170_p, (String)"The King", (double)this.field_70165_t, (double)this.field_70163_u, (double)this.field_70161_v);
                if (ent != null) {
                    d = (TheKing)ent;
                    d.setFree();
                    this.func_70106_y();
    ...
    public boolean func_70085_c(EntityPlayer par1EntityPlayer) {
        ...
        if (this.func_70909_n()) {
            ...
            if (var2 != null && var2.func_77973_b() == Items.field_151045_i && par1EntityPlayer.func_70068_e((Entity)this) < 36.0 && !this.field_70170_p.field_72995_K) {
                ...
                ent = ThePrinceAdult.spawnCreature((World)this.field_70170_p, (String)"The Young Prince", (double)this.field_70165_t, (double)this.field_70163_u, (double)this.field_70161_v);
                if (ent != null) {
                    d = (ThePrinceTeen)ent;
                    if (this.func_70909_n()) {
                        d.func_70903_f(true);
