...
extends EntityTameable {
    ...
    public Spyro(World par1World) {
        ...
        this.field_70714_bg.func_75776_a(3, (EntityAIBase)new MyEntityAIFollowOwner((EntityTameable)this, 1.15f, 12.0f, 2.0f));
    ...
    public boolean func_70085_c(EntityPlayer par1EntityPlayer) {
        ...
        if (this.func_70909_n() && var2 != null && var2.func_77973_b() == Items.field_151045_i && par1EntityPlayer.func_70068_e((Entity)this) < 16.0 && this.func_152114_e((EntityLivingBase)par1EntityPlayer) && !this.field_70170_p.field_72995_K) {
            Entity ent = null;
            Dragon d = null;
            ent = Spyro.spawnCreature((World)this.field_70170_p, (String)"Dragon", (double)this.field_70165_t, (double)this.field_70163_u, (double)this.field_70161_v);
            if (ent != null) {
                d = (Dragon)ent;
                if (this.func_70909_n()) {
                    d.func_70903_f(true);
