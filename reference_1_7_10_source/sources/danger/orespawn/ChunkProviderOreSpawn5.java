...
implements IChunkProvider {
    ...
    public void addCrystalTrees(World world, Random random, int chunkX, int chunkZ, Chunk chunk) {
        ...
        block0: for (int i = 0; i < howmany; ++i) {
            ...
            for (int posY = 128; posY > 40; --posY) {
                if (OreSpawnMain.getBlockIDInChunk((Chunk)chunk, (int)posX, (int)posY, (int)posZ) != Blocks.field_150350_a || OreSpawnMain.getBlockIDInChunk((Chunk)chunk, (int)posX, (int)(posY - 1), (int)posZ) != OreSpawnMain.CrystalGrass) continue;
                if (what == 0) {
    ...
    public void makeScragglyCrystalBranch(World world, int x, int y, int z, int len, int biasx, int biasz, Chunk chunk) {
        for (int k = 0; k < len; ++k) {
            ...
            if ((bid = OreSpawnMain.getBlockIDInChunk((Chunk)chunk, (int)(x += ix), (int)(y += (iy = world.field_73012_v.nextInt(3) > 0 ? 1 : 0)), (int)(z += iz))) != Blocks.field_150350_a && bid != OreSpawnMain.MyCrystalTreeLog && bid != OreSpawnMain.MyCrystalLeaves2) {
                return;
            }
            OreSpawnMain.setBlockIDWithMetadataInChunk((Chunk)chunk, (int)x, (int)y, (int)z, (Block)OreSpawnMain.MyCrystalTreeLog, (int)0);
            for (int m = -1; m < 2; ++m) {
                for (int n = -1; n < 2; ++n) {
                    if (world.field_73012_v.nextInt(2) != 1 || (bid = OreSpawnMain.getBlockIDInChunk((Chunk)chunk, (int)(x + m), (int)y, (int)(z + n))) != Blocks.field_150350_a) continue;
                    OreSpawnMain.setBlockIDWithMetadataInChunk((Chunk)chunk, (int)(x + m), (int)y, (int)(z + n), (Block)OreSpawnMain.MyCrystalLeaves2, (int)0);
                }
            }
            if (world.field_73012_v.nextInt(2) != 1 || (bid = OreSpawnMain.getBlockIDInChunk((Chunk)chunk, (int)x, (int)(y + 1), (int)z)) != Blocks.field_150350_a) continue;
    ...
    public void TallCrystalTree(World world, int x, int y, int z, Chunk chunk) {
        ...
        y += i - 1;
        for (k = i; k < j && ((bid = OreSpawnMain.getBlockIDInChunk((Chunk)chunk, (int)x, (int)(++y), (int)z)) == Blocks.field_150350_a || bid == OreSpawnMain.MyCrystalTreeLog || bid == OreSpawnMain.MyCrystalLeaves); ++k) {
            OreSpawnMain.setBlockIDWithMetadataInChunk((Chunk)chunk, (int)x, (int)y, (int)z, (Block)OreSpawnMain.MyCrystalTreeLog, (int)0);
            if (k % 4 != 0) continue;
            for (m = -1; m < 2; ++m) {
                for (n = -1; n < 2; ++n) {
