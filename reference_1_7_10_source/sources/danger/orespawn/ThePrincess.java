...
extends EntityTameable {
    ...
    public ThePrincess(World par1World) {
        ...
        this.field_70714_bg.func_75776_a(2, (EntityAIBase)new MyEntityAIFollowOwner((EntityTameable)this, 1.15f, 12.0f, 2.0f));
    ...
    protected void func_70619_bc() {
        ...
        if (this.attack_level > 500) {
            if (this.getAttacking() != 0) {
                int j = 3;
                for (int i = 0; i < j; ++i) {
                    Entity ppwr = ThePrincess.spawnCreature((World)this.field_70170_p, (String)"PurplePower", (double)(this.field_70165_t - xzoff * Math.sin(Math.toRadians(this.field_70177_z))), (double)(this.field_70163_u + yoff), (double)(this.field_70161_v + xzoff * Math.cos(Math.toRadians(this.field_70177_z))));
                ...
                for (m = 0; m < 2; ++m) {
                    ...
                    newent = this.field_70170_p.field_73012_v.nextInt(2) == 0 ? (EntityLiving)ThePrincess.spawnCreature((World)this.field_70170_p, (String)"Butterfly", (double)(this.field_70165_t + (double)i), (double)(this.field_70163_u + (double)j), (double)(this.field_70161_v + (double)k)) : (EntityLiving)ThePrincess.spawnCreature((World)this.field_70170_p, (String)"Bird", (double)(this.field_70165_t + (double)i), (double)(this.field_70163_u + (double)j), (double)(this.field_70161_v + (double)k));
                }
            }
            this.attack_level = 1;
        }
