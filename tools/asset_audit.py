...
# sampler's output, tools/reference_clips/<registry>_reference_<state>.animation.json (the single
# <registry>_reference.animation.json before 2026-09-14) - the classic hook sampled at fixed inputs for the artist to look
# at - is carried beside each species' sheet and NEVER shipped; the package checker refuses a returned one under
# its own name, and this audit refuses one anywhere under src/main/resources (never acknowledgeable).
#
