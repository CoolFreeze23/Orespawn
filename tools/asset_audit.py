...
# The reference-only clip: the package sampler's output,
...
def check_geckolib(java_texts):
    ...
    # The reference-only clip never ships: a *_reference.animation.json anywhere under src/main/resources is an
    # ERROR naming the file, never acknowledgeable - the package copies it beside the sheet from
    # tools/reference_clips/ and the checker refuses a returned one; the jar carries none.
